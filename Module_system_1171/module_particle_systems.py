...
##### Dungeon Water Drops  END #####
    ...
    #add new here
    ("sword_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     10, 0.15, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 0), (1, 0),      #red keys
     (0.5, 0),(1, 0),       #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
     (0, 0.3),   (0.4, 0.3),   #scale keys
     (0.1, 0.1, 0.1),      #emit box size
     (0, 0, 0.5),               #emit velocity
     0.0,                       #emit dir randomness
     200,                       #rotation speed
    ...
    ("sword_fire1", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     200, 0.15, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 0.2), (1, 0),      #red keys
     (0.5, 0),(1, 0),       #green keys
     (0.5, 0), (1, 0.0),      #blue keys
     (0, 0.3),   (0.4, 0.3),   #scale keys
     (0.1, 0.6, 0.1),      #emit box size
     (0, 0, 0.5),               #emit velocity
     0.0,                       #emit dir randomness
     200,                       #rotation speed
     0.5                        #rotation damping
    ),
    ("bomb_fire", psf_billboard_3d|psf_global_emit_dir|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     200, 1.0, 0, -0.3, 20.0, 5.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
     (0.2, 0.2), (1, 0.0),      #blue keys
     (0, 0.45),   (1, 0.45),    #scale keys
     (2.5, 2.5, 1.2),           #emit box size
     (0, 0, 0.0),               #emit velocity
     0.0,                       #emit dir randomness
     250,                       #rotation speed
     0.3                        #rotation damping
    ),
    ("bomb_fire_extra", psf_billboard_3d|psf_global_emit_dir|psf_randomize_size,  "prt_mesh_fire_1",
     200, 1.0, 0, -0.3, 20.0, 5.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
    ...
    ("bomb_fire_extra1", psf_billboard_3d, "prtcl_dust_a",
     90, 2, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
    ...
    ("bolt_fire", psf_billboard_3d|psf_global_emit_dir|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     200, 1.0, 0, -0.3, 20.0, 5.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
    ...
    ("magic_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_steam_1",
     200, 0.15, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 0.1), (1, 0),      #red keys
     (0.5, 0),(1, 0),       #green keys
     (0.5, 0.5), (1, 0.0),      #blue keys
     (0, 0.3),   (0.4, 0.3),   #scale keys
    ...
    ("magic_fire_bow", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_steam_1",
     250, 0.15, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 0.1), (1, 0),      #red keys
     (0.5, 0),(1, 0),       #green keys
     (0.5, 0.5), (1, 0.0),      #blue keys
    ...
    ("nothing", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "00_hide",
     2000, 0.6, 3, 0.3, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.25), (0.7, 0.1),        #alpha keys
     (0.1, 0.7), (1, 0.7),      #red keys
     (0.1, 0.7), (1, 0.7),       #green keys

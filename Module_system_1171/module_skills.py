...
skills = [
  ("trade","Trade",sf_base_att_cha|sf_effects_party,12,"Every level of this skill reduces your trade penalty by 5%%. (Party skill)"),
  ("leadership","Leadership",sf_base_att_cha,12,"Every point increases maximum number of troops you can command by 5, increases your party morale and reduces troop wages by 5%%. (Leader skill)"),
  ("prisoner_management", "Prisoner Management",sf_base_att_cha,12,"Every level of this skill increases maximum number of prisoners by %d. (Leader skill)"), 
  ...
  ("reserved_5","Magic",sf_base_att_int,12,"This is a reserved skill."), 
  ("reserved_6","Magic Power",sf_base_att_int,12,"This is a reserved skill."), 
  ...
  ("looting","Looting",sf_base_att_agi|sf_effects_party,12,"This skill increases the amount of loot obtained by 10%% per skill level. (Party skill)"), 
  ("horse_archery","Horse Archery",sf_base_att_agi,12,"Reduces damage and accuracy penalties for archery and throwing from horseback. (Personal skill)"),
  ("riding","Riding",sf_base_att_agi,12,"Enables you to ride horses of higher difficulty levels and increases your riding speed and manuever. (Personal skill)"),
  ("athletics","Athletics",sf_base_att_agi,12,"Improves your running speed. (Personal skill)"),
  ("shield","Shield",sf_base_att_agi,12,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)"),
  ("weapon_master","Weapon Master",sf_base_att_agi,12,"Makes it easier to learn weapon proficiencies and increases the proficiency limits. Limits go as: 60, 100, 140, 180, 220, 260, 300, 340, 380, 420. (Personal skill)"),
  ...
  ("power_draw","Power Draw",sf_base_att_str,12,"Lets character use more powerful bows. Each point to this skill (up to four plus power-draw requirement of the bow) increases bow damage by 14%%. (Personal skill)"),
  ("power_throw","Power Throw",sf_base_att_str,12,"Each point to this skill increases throwing damage by 10%%. (Personal skill)"),

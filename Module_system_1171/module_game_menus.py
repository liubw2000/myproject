...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
      ##########################################
        ("start_test",[(eq,1,1),],"Test...",
       [
         (troop_set_type,"trp_player", 8),
         (assign,"$character_gender",tf_male),
         (assign,"$test_mode_start",1),
         (assign,"$regular_start",1),
         (assign,"$cheat_mode",1),
         ...
         (troop_raise_skill, "trp_player","skl_riding",8),
         (troop_add_item, "trp_player","itm_tab_shield_round_d",0),
         (troop_add_item, "trp_player","itm_charger",0),
         (troop_add_item, "trp_player","itm_coat_of_plates",0),
         (troop_add_item, "trp_player","itm_warhammer",0),
         (troop_add_item, "trp_player","itm_apples",0),
         (troop_add_item, "trp_player","itm_great_helmet",0),
         (troop_add_item, "trp_player","itm_pistol_for_test",0),
         (troop_add_item, "trp_player","itm_cartridges",0),
         (troop_add_gold, "trp_player",500000),
         (troop_set_name, "trp_player", "str_yes"),
         (party_add_members,"p_main_party","trp_death_knight",1),
         (party_add_members,"p_main_party","trp_hunger_knight",1),
         (party_add_members,"p_main_party","trp_conquer_knight",1),
         (party_add_members,"p_main_party","trp_war_knight",1),
         (call_script,"script_set_player_relation_with_faction","fac_kingdom_6",-5),
         (call_script,"script_init_faction_relation",1),
         (call_script, "script_player_arrived"),
        #  (jump_to_menu, "mnu_start_test_1"),
         (change_screen_return),
       ]),
       ##########################################
     ("continue",[],"Continue...",
       [(call_script,"script_init_faction_relation",1),(assign,"$regular_start",1),(jump_to_menu, "mnu_start_game_1"),
        ]
       ),
     ("glory_of_calradic_empire",[],"Glory of calradic empire",
       [(call_script,"script_init_faction_relation",2),(assign,"$glory_of_calradic_empire",1),(jump_to_menu, "mnu_start_game_1"),
        ]
       ),
      ("go_back",[],"Go back",
       [
...
# ("start_test_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
...
#        ]
#        ),
#       ("start_beautiful_female",[],"Beautiful female",
#        [
...
#  and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Calradia and its kingdoms, you...",
    ...
    [
      #################
      ("test_town",[(eq, "$current_startup_quest_phase", 0),(eq,"$test_mode_start",1),],"Test start.",
       [
       ...
       ("visit_parent",[(eq, "$current_startup_quest_phase", 0),(eq,"$glory_of_calradic_empire",1),],"Visit your parent.",
       [  
          (assign, "$current_town", "p_town_6"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_praven"),
          (jump_to_menu, "mnu_start_phase_2_5_glory"),
          # (change_screen_return),(eq,"$glory_of_calradic_empire",0),
       ]),
      ##################
      ("town_1",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"join a caravan to Praven, in the Kingdom of Swadia.",
       [
         (assign, "$current_town", "p_town_6"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_praven"),
...
#         (change_screen_return),
      ...
      ("town_2",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"join a caravan to Reyvadin, in the Kingdom of the Vaegirs.",
       [
...
#         (change_screen_return),
      ...
      ("town_3",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"join a caravan to Tulga, in the Khergit Khanate.",
       [
...
#         (change_screen_return),
      ...
      ("town_4",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"take a ship to Sargoth, in the Kingdom of the Nords.",
       [
...
#         (change_screen_return),
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"take a ship to Jelkala, in the Kingdom of the Rhodoks.",
       [
...
#         (change_screen_return),
      ...
      ("town_6",[(eq, "$current_startup_quest_phase", 0),(eq,"$regular_start",1),],"join a caravan to Shariz, in the Sarranid Sultanate.",
       [
  ...
  ("reports",0,
   ...
   [(call_script, "script_game_get_party_companion_limit"),
    ...
    [
      ...
      ("cation_view_all_items",[],"View all items.",
      [(assign,"$temp",0),
      (start_presentation, "prsnt_all_items"),
      ]
    ),

      ("action_view_upgrade_trees",[],"View upgrade trees.",#troop_update,kingdoms
       [
        (assign, "$temp", 0),
      ...
      ("action_view_upgrade_trees_1",[],"View upgrade trees.",#troop_update
       [
        (assign, "$temp", 0),
        (start_presentation, "prsnt_faction_upgrade_trees_1"),
        ]
       ),
      ("action_view_hero_note",[],"View upgrade trees.",#hero_note
       [
        (assign, "$temp", 0),
        (start_presentation, "prsnt_hero_note"),
        ]
       ),
...
#NPC companion changes end
      ...
      ("action_view_faction_rela",[],"View relations.",#
       [
        (assign, "$temp", 0),
        # (start_presentation, "prsnt_relation_with_lower_factions"),
        (start_presentation, "prsnt_hero_army_report"),
        ]
       ),
...
##    ]),
  ...
  (
    ...
    [(assign, reg3, "$character_gender"),
     (try_begin),
      (eq,"$glory_of_calradic_empire",1),#change text
      (str_store_string,s21,"str_a_letter_from_your_parent"),
     (else_try),
      (str_store_string,s21,"str_but_soon_everything_changed_and_you"),
     (try_end),
     ],
    [
...
##        ]),
  ...
  (
    ...
    [],
    [
      ("revenge",[(eq,"$regular_start",1),],"Personal revenge.",[
 ...
 and these debts can only be paid in blood..."),
      ...
      ("death",[(eq,"$regular_start",1),],"The loss of a loved one.",[
 ...
 or honour the name that you can no longer bear to speak..."),
      ...
      ("wanderlust",[(eq,"$regular_start",1),],"Wanderlust.",[
...
##        (jump_to_menu,"mnu_choose_skill"),
##        ]),
      ("disown",[(eq,"$regular_start",1),],"Being forced out of your home.",[
 ...
 now, and you must face the fact that you're out in the wide wide world. Alone to sink or swim..."),
     ...
     ("greed",[(eq,"$regular_start",1),],"Lust for money and power.",[
 ...
 You want everything, and you won't let anyone stop you from having it..."),
      ...
      ("wealth",[(eq,"$glory_of_calradic_empire",1),],"a lot of denar.",[
        (assign,"$background_answer_4", cb4_wealth),
      (str_store_string,s13,"str_take_your_money_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("sword",[(eq,"$glory_of_calradic_empire",1),],"Sword.",[
        (assign,"$background_answer_4",cb4_sword),
      (str_store_string,s13,"str_take_your_sword_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("armor",[(eq,"$glory_of_calradic_empire",1),],"Armor.",[
        (assign,"$background_answer_4",cb4_armor),
      (str_store_string,s13,"str_take_your_armor_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("goods",[(eq,"$glory_of_calradic_empire",1),],"Goods.",[
        (assign,"$background_answer_4",cb4_goods),
      (str_store_string,s13,"str_take_your_goods_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
     ("brother",[(eq,"$glory_of_calradic_empire",1),],"Your little brother.",[
        (assign,"$background_answer_4",cb4_brother),
      (str_store_string,s13,"str_take_your_brother_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("sister",[(eq,"$glory_of_calradic_empire",1),],"Your little sister.",[
        (assign,"$background_answer_4",cb4_sister),
      (str_store_string,s13,"str_take_your_sister_and_go"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("go_back",[],"Go back.",
       [(jump_to_menu,"mnu_start_character_3"),
...
##        ]),
     ...
     (try_begin),
      (eq,"$glory_of_calradic_empire",1),#change text
      (str_store_string,s22,"str_trip_to_visit_your_parent"),
     (else_try),
      (str_store_string,s22,"str_run_for_your_destiny"),
     (try_end),
     ],"{s22}",[
...
##        (troop_raise_proficiency, "trp_player",5,10),
      ...
      (else_try),
        ...
        (troop_raise_skill, "trp_player",skl_looting,1),
      (else_try),
        (eq,"$background_answer_4",cb4_sword),
        (troop_add_item,"trp_player","itm_scottish_claymore"),
        (troop_raise_skill, "trp_player",skl_power_strike,1),
      (else_try),
        (eq,"$background_answer_4",cb4_armor),
        (troop_add_item,"trp_player","itm_scale_armor",imod_rusty),
        (troop_add_item,"trp_player","itm_scale_gauntlets",imod_rusty),
        (troop_add_item,"trp_player","itm_mail_chausses",imod_rusty),
        (troop_raise_skill, "trp_player",skl_ironflesh,1),
      (else_try),
        (eq,"$background_answer_4",cb4_goods),
        (troop_add_items,"trp_player","itm_spice",2),
        (troop_add_items,"trp_player","itm_oil",2),
        (troop_add_items,"trp_player","itm_linen",2),
        (troop_add_items,"trp_player","itm_raw_flax",2),
        (troop_add_items,"trp_player","itm_raw_silk",2),
        (troop_add_items,"trp_player","itm_velvet",2),
        (troop_add_items,"trp_player","itm_tools",2),
        (troop_add_items,"trp_player","itm_wine",2),
        (troop_raise_skill, "trp_player",skl_trade,1),
        (troop_raise_skill, "trp_player",skl_inventory_management,1),
      (else_try),
        (eq,"$background_answer_4",cb4_brother),
        (troop_raise_skill, "trp_player",skl_leadership,1),
      (else_try),
        (eq,"$background_answer_4",cb4_sister),
        (troop_raise_skill, "trp_player",skl_leadership,1),
      (try_end),

      (try_begin),
        (eq,"$glory_of_calradic_empire",1),
        (troop_raise_skill, "trp_player",skl_tactics,1),
        (troop_raise_skill, "trp_player",skl_leadership,1),
        (troop_raise_attribute,"trp_player",ca_charisma,1),
        (troop_raise_attribute,"trp_player",ca_strength,1),
      ...
      #libwe,new
      (troop_get_type,":player_type","trp_player"),
      (try_begin),
      (eq,":player_type",0),#male
      (troop_raise_attribute,"trp_player",ca_intelligence,1),
      (troop_raise_attribute,"trp_player",ca_agility,1),
      (troop_raise_attribute,"trp_player",ca_strength,1),
      (else_try),  
      (eq,":player_type",1),#female
      (troop_raise_attribute,"trp_player",ca_agility,1),
      (troop_raise_attribute,"trp_player",ca_intelligence,1),
      (troop_raise_attribute,"trp_player",ca_charisma,1),
      (else_try),  
      (eq,":player_type",4),#tall male
      (troop_raise_attribute,"trp_player",ca_strength,3),
      (else_try),  
      (eq,":player_type",3),#beautiful female
      (troop_raise_attribute,"trp_player",ca_charisma,3),
      (try_end),

      (try_begin),
        (eq,"$glory_of_calradic_empire",1),
        (str_store_string,s20,"str_visit_your_parents"),#visit your parents
      (else_try),
        (str_store_string,s20,"str_you_hear_about_calradia"),
      (try_end),
      # end
...
#             (start_presentation, "prsnt_custom_banner"),
  ...
  ("camp",mnf_scale_picture,
   ...
   [
    ...
    [
      ("camp_test",[(eq,"$cheat_mode",1)],"Test...",
      ...
      ("camp_action_2",[],"mod setting.",
       [(start_presentation,"prsnt_new_mod_setting"),
        ]
       ),
  ...
  ("camp_action",0,
   ...
   [
    ...
    [
      ...
      ("action_buy_chest",
       [
        (eq,"$player_have_chest",0),
         ],"Buy a chest(10000 denar).",
       [(assign,"$player_have_chest",1),
       (troop_remove_gold,"trp_player",10000),
       (display_message,"@you buy a chest"),]),
      ("action_open_chest",
       [
        (eq,"$player_have_chest",1),
         ],"Buy a chest(10000 denar).",
       [(change_screen_loot,"trp_player_chest"),]),
      ("action_upgrade_chest",
       [
        (eq,"$player_have_chest",1),
        (store_skill_level,":cur_lev","skl_inventory_management","trp_player_chest"),
        (lt,":cur_lev",10),
         ],"Upgrade chest(10000 denar).",
       [(troop_raise_skill,"trp_player_chest","skl_inventory_management",3),
       (troop_remove_gold,"trp_player",10000),
       (display_message,"@your chest has been upgrade")]),
  ...
  (
    ...
    [
      ("pre_join_help_attackers",[
          ...
          (ge, ":attacker_relation", -50),#libwe
          (lt, ":defender_relation", 50),
          ],
          ...
          (try_begin),
            (faction_slot_eq,":attacker_faction",slot_faction_rela_can_chan,1),
            (call_script,"script_change_player_relation_with_faction",":attacker_faction",3),
          (try_end),

          (try_begin),
            (faction_slot_eq,":defender_faction",slot_faction_rela_can_chan,1),
            (assign,":ral_loss",-3),
              (try_begin),
                (ge,":defender_relation",15),
                (call_script, "script_change_player_honor",-1),
                (assign,":ral_loss",-5),
              (try_end),
            (call_script,"script_change_player_relation_with_faction",":defender_faction",":ral_loss"),
          (try_end),
      ...
      ("pre_join_help_defenders",[
          ...
          (store_faction_of_party, ":defender_faction", "$g_encountered_party"),
          (store_relation, ":defender_relation", ":defender_faction", "fac_player_supporters_faction"),
          (ge, ":defender_relation", -50),
          (lt, ":attacker_relation", 50),
          ],
          ...
          (try_begin),
            ...
            (assign,":ral_loss",-3),
            (try_begin),
              (ge,":attacker_relation",15),
              (call_script, "script_change_player_honor",-1),
              (assign,":ral_loss",-5),
            (try_end),
          (call_script,"script_change_player_relation_with_faction",":attacker_faction",":ral_loss"),
          (try_end),

          (try_begin),
            (faction_slot_eq,":defender_faction",slot_faction_rela_can_chan,1),
            (call_script,"script_change_player_relation_with_faction",":defender_faction",3),
          (try_end),
...
# Towns
  (
    ...
    [
      ("zendar_enter",[],"_",[(assign,"$talk_context",-1),(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_zendar_center"),(change_screen_mission)],"Door to the town center."),
      ("zendar_tavern",[],"_",[(set_jump_mission,"mt_town_default"),
                                                   (assign,"$talk_context",tc_zendar_tavern),
                                                   (jump_to_scene,"scn_the_happy_boar"),
                                                   (modify_visitors_at_site, "scn_the_happy_boar"),
                                                    (reset_visitors),
                                                    (set_visitor, 0, "trp_player"),
                                                    (try_begin),
                                                      (eq,"$glory_main_quest_phase", 1),
                                                      (check_quest_active,"qst_visit_zendar"),
                                                      (set_visitor, 20, "trp_aerys"),
                                                      (set_visitor, 23, "trp_tallad"),
                                                      (set_visitor, 22, "trp_elaena"),
                                                    (try_end),
                                                    (try_begin),
                                                      (check_quest_active,"qst_destory_sea_raider_zendar"),
                                                      (set_visitor, 20, "trp_npc2"),
                                                    (try_end),
                                                    (set_visitor, 26, "trp_vorian_singer"),  
                                                    (set_visitor, 24, "trp_alexis"),
...
#new site in map
  (
    "spring_knight_castle",0,
    "You enter the Keep",
    "none",
    [],
    [
      ("enter",[],"Enter.",[
        (assign,"$talk_context",tc_common_guard_talk),
        (set_jump_mission,"mt_town_default"),
        (jump_to_scene,"scn_spring_knight_castle"),
        (modify_visitors_at_site, "scn_spring_knight_castle"),
        (reset_visitors),
        (set_visitor, 0, "trp_player"),
        (set_visitor, 21, "trp_old_knight_gideon"),
        (set_visitor, 22, "trp_spring_lake_guard"),
        (set_visitor, 23, "trp_spring_lake_guard"),
        (set_visitor, 24, "trp_spring_lake_guard"),
        (set_visitor, 25, "trp_spring_lake_guard"),        
        (change_screen_mission),
        ]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ...
  (
    ...
    [
      ("enter",[],"Enter.",[
        (assign,"$talk_context",tc_common_guard_talk),
        (set_jump_mission,"mt_town_default"),
        (jump_to_scene,"scn_merchant_castle"),
        (modify_visitors_at_site, "scn_merchant_castle"),
        (reset_visitors),
        (set_visitor, 0, "trp_player"),
        (set_visitor, 21, "trp_regis"),
        (set_visitor, 22, "trp_war_sister_knight"),
        (set_visitor, 23, "trp_woman_crossbow_elite"),
        (set_visitor, 24, "trp_mercenary_knight"),
        (set_visitor, 25, "trp_hired_blade"),
        (change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    ...
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_brotherhood_site"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    "sea_banit_group_site",0,
    "You enter the Keep",
    "none",
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_sea_banit_group_site"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  #new site in map end
...
##  ),
  ...
  (
    ...
    [
        ...
        (try_end),
      #new#libwe
      (party_get_slot,":cur_stability","$current_town", slot_center_stability),
      (party_get_slot,":cur_corruption","$current_town", slot_chaos_corruption),
      (assign,reg9,":cur_stability"),
      (assign,reg8,":cur_corruption"),
      #
        (str_clear, s11),
        (try_begin),
    ...
    [
      ...
      ("village_talk_to_elder",[
        ...
        (party_get_slot, ":cur_elders","$current_town", slot_town_elder),
        (call_script, "script_get_meeting_scene"), (assign, ":meeting_scene", reg0),
        (modify_visitors_at_site,":meeting_scene"),(reset_visitors),
        (set_visitor,0,"trp_player"),
        (set_visitor,17,":cur_elders"),
        (set_jump_mission,"mt_conversation_encounter"),
        (jump_to_scene,":meeting_scene"),
        # (assign, "$talk_context", tc_castle_gate),
        (change_screen_map_conversation,":cur_elders"),
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
 ...
 currently building {s7}. The building will be completed after {reg8} day{reg9?s:}.:}",
    ...
    [(assign, ":num_improvements", 0),
     ...
     (else_try),
       (assign, ":begin", walled_center_improvements_begin),
       (assign, ":end", slot_center_has_square),
    ...
    [
      ...
      #new buildings
      ("center_build_inn",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_inn, 0),
                                       ],
       "Build a inn.",[(assign, "$g_improvement_type", slot_center_has_inn),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_hunter_hut",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_hunter_hut, 0),
                                       ],
       "Build a hunter hut.",[(assign, "$g_improvement_type", slot_center_has_hunter_hut),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_trade_station",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_trade_station, 0),
                                       ],
       "Build a trade station.",[(assign, "$g_improvement_type", slot_center_has_trade_station),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_patrol_station",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_prisoner_tower, 0),
                                       ],
       "Build a patrol station.",[(assign, "$g_improvement_type", slot_center_has_patrol_station),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_square",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_square, 0),
                                       ],
       "Build a square.",[(assign, "$g_improvement_type", slot_center_has_square),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_theater",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_theater, 0),
                                       ],
       "Build a theater.",[(assign, "$g_improvement_type", slot_center_has_theater),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_college",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_college, 0),
                                       ],
       "Build a college.",[(assign, "$g_improvement_type", slot_center_has_college),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_church",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_church, 0),
                                       ],
       "Build a church.",[(assign, "$g_improvement_type", slot_center_has_church),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_manhunter_union",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_manhunter_union, 0),
                                       ],
       "Build a manhunter_union.",[(assign, "$g_improvement_type", slot_center_has_manhunter_union),
                                  (jump_to_menu, "mnu_center_improve"),]),
 ...
 {reg5} denars and will take {reg6} days.",
    ...
    [(call_script, "script_get_improvement_details", "$g_improvement_type"),
     ...
     (assign, reg2, ":max_skill"),
     #new
     (val_mul,":max_skill",2),#can be influence by skill more

     (store_sub, ":multiplier", 25, ":max_skill"),
     (val_mul, ":improvement_cost", ":multiplier"),
     (val_div, ":improvement_cost", 25),
     
     (store_div, ":improvement_time", ":improvement_cost", 300),#add 200
         ...
         (else_try),
           ...
           (else_try),
            #  (party_get_slot, ":town_original_faction", "$current_town", slot_center_original_faction),
              (faction_get_slot,":town_original_faction","fac_player_supporters_faction",slot_faction_culture),
              # (val_sub,":town_original_faction","fac_culture_1"),
              # (val_add,":town_original_faction","fac_kingdom_1"),
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             (try_for_range, ":companion_candidate", companions_begin, companions_end),
               ...
               (this_or_next|eq,"$regular_start",1),
               (troop_slot_eq, ":companion_candidate", slot_troop_met_previously, 1),#must meet them before
            ...
            (assign,":bard",0),#dedal
             ...
             (try_end),       
              ...
              (try_begin),#libwe
               (party_get_slot, ":tavern_mercenary_intermediary", "$current_town", slot_center_mercenary_intermediary),
               (gt, ":tavern_mercenary_intermediary", 0),
               (set_visitor, ":cur_entry", ":tavern_mercenary_intermediary"),
               (val_add, ":cur_entry", 1),
             (try_end),

             (try_begin),#
               (party_slot_eq, "$current_town", slot_center_has_manhunter_union,1),
               (store_random_in_range,":trp_no","trp_manhunter_contact_1","trp_alayen"),
               (set_visitor, ":cur_entry", ":trp_no"),
               (val_add, ":cur_entry", 1),
             (try_end),
                    #dedal begin
                        (try_for_range,":entry",32,41),
                                        (store_random_in_range,":r",0,100),
                                        (gt,":r",30),#random chance of spawning
                                        (try_begin),
                                                (eq,":bard",0),
                                                ...
                                                (assign,":bard",1),
                                        (else_try),
                                                (party_get_slot,":culture_no","$g_encountered_party",slot_center_culture),
                                                (faction_get_slot,":male_walker",":culture_no", slot_faction_town_walker_male_troop),
                                                (faction_get_slot,":female_walker",":culture_no", slot_faction_town_walker_female_troop),
                                                (store_add,":walker_1",":female_walker",1),
                                                (store_random_in_range,":town_walker",":male_walker",":walker_1"),
                                                (assign,":drinker",":town_walker"),

                                                (try_for_range,":des",0,6),
                                                  (eq,"$town_nighttime",1),
                                                  (store_add,":slot_no",":des",slot_center_has_mafia1),
                                                  (party_get_slot,":have_mafia","$g_encountered_party",":slot_no"),
                                                  (eq,":have_mafia",1),
                                                  (store_add,":troop_no",":des","trp_black_khergit_horseman"),
                                                  (assign,":drinker",":troop_no"),
                                                (try_end),
                                                ...
                                                (try_end),
                                                (set_visitor,":entry",":drinker",":dna"),
                                        (try_end),
                        (try_end),
                        #dedal end
                (try_begin),
                    (eq,"$g_encountered_party","p_town_4"),
                    (set_visitor,27,"trp_simon"),
                (try_end),
             (change_screen_mission),
           (try_end),
        ],"Door to the tavern."),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
      ...
      ("town_dungeon",
       ...
       [	   
        ...
        # (val_sub,":culture","fac_culture_1"),#use culture directly
        # (val_add,":culture","fac_kingdom_1"),
        (assign, ":prison_guard_faction", ":culture"),
       ...
       [
         ...
         (else_try),                   
           ...
           (else_try),
              ...
              # (val_add,":culture","fac_kingdom_1"),
            #  (party_get_slot, ":town_original_faction", "$current_town", slot_center_original_faction),
             (faction_get_slot, ":troop_prison_guard", ":culture", slot_faction_prison_guard_troop),
           (try_end),
           (set_visitor, 24, ":troop_prison_guard"),
...
##          ]),
      ...
      [
       ...
       ##################Libwe
      ("town_talk_to_elder",[(is_between,"$current_town",towns_begin,towns_end)],"visit elder",[      
        (party_get_slot, ":cur_elders","$current_town", slot_town_elder),
      ...
      ("recruit_nobleman_town",
      [
        (call_script, "script_cf_recruit_noblemen_cond"),
       ]
       ,"Recruit Noblemen.",
       [(jump_to_menu, "mnu_recruit_noblemen"),
       ]),
      ##################
...
#libwe#end
  (
    ...
    [(party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
     ...
     (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
     (store_troop_gold, ":gold", "trp_player"),
     (store_div, ":gold_capacity", ":gold", 500),#10 denars per man
     (assign, ":party_capacity", ":free_capacity"),
     (val_min, ":party_capacity", ":gold_capacity"),
     (try_begin),
       (gt, ":party_capacity", 0),
     ...
     (try_begin),
       ...
       (str_store_string, s18, "@No one here seems to be willing to join your party."),
     (else_try),
       (store_mul, reg6, ":volunteer_amount", 500),#10 denars per man
       (str_store_troop_name_by_count, s3, ":volunteer_troop", ":volunteer_amount"),
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@One {s3} volunteers to follow you."),
    ...
    [
      ...
      "Recruit them ({reg6} denars).",
      [
        (call_script, "script_recruit_noblemen_recruit"),
...
#          (try_end),
  ...
  ("start_phase_2_5_glory",mnf_disable_all_keys,
    "Everything seems fine",
    "none",
    [(assign,"$assassin_in_scene",0),],
    [
      ("continue",[], "Continue...",
       [
		 (jump_to_menu, "mnu_start_phase_3_glory"),
       ]),
    ]
  ),

  ("start_phase_3_glory",mnf_disable_all_keys,
    "{!}{s11}",
    "none",
    [
      (assign, ":continue", 1),
      (try_begin),
      (eq,"$assassin_in_scene",0),
      (str_store_string, s11, "str_see_your_parents"),
      (else_try),
      (eq,"$assassin_in_scene",1),
        (try_begin),
          (eq, "$kill_all_assassin", 1),
          (str_store_string, s11, "str_kill_all_assassin"),
        (else_try),  
          (str_store_string, s11, "str_killed_by_assassin"),
        (try_end),     
      (try_end),     
      (eq, ":continue", 1),
    ],
    [
      ("continue",[(eq,"$assassin_in_scene",0)], "Continue...",
       [(assign,"$assassin_attack",0),
      #  (assign,"$mother_start_talk",0),
		    (call_script, "script_player_arrived"),
        (party_set_morale, "p_main_party", 100),
        (modify_visitors_at_site, "scn_start_scene_1"),
        (reset_visitors),
        (set_visitor, 0, "trp_player"),
        (set_visitor, 10, "trp_father"),
        (set_visitor, 11, "trp_mother"),
        (set_visitor,3,"trp_villager"),
        (set_visitor,5,"trp_villager"),
        (set_visitor,6,"trp_villager_woman"),
        (set_visitor,2,"trp_villager_woman"),
        (set_visitor,4,"trp_villager"),
        (set_visitor,12,"trp_villager"),
        (set_visitor,13,"trp_villager_woman"),
        (set_jump_mission, "mt_assassin_attack_1"),
        (jump_to_scene, "scn_start_scene_1"),
        (change_screen_mission),  
       ]),
      ("continue",[(eq,"$assassin_in_scene",1)], "Continue...",
       [
         (jump_to_menu, "mnu_start_phase_4_glory"),
       ]),
    ]
  ),

("start_phase_4_glory",mnf_disable_all_keys,
    "find not dead",
    "none",
    [],
    [
      ("continue",[], "Continue...",
       [(jump_to_menu, "mnu_start_phase_5_glory"),
       ]),
    ]
  ),

  ("start_phase_5_glory",mnf_disable_all_keys,#libwe
    "You travel to search this guy",
    "none",
    [],
    [
      ("continue",[], "Continue...",
       [
        (call_script, "script_start_quest", "qst_chaper_one_glory", 0),

        (modify_visitors_at_site, "scn_start_scene_2"),     
        (reset_visitors),
        (set_visitor, 0, "trp_player"),    
        (set_visitor,1,"trp_refugee"),
        (set_visitor,2,"trp_nord_warrior"),
        (set_visitor,3,"trp_nord_warrior"),
        (set_visitor,4,"trp_nord_archer"),
        (set_visitor,5,"trp_nord_veteran_archer"),
        (set_visitor,6,"trp_caravan_guard"),
        (set_visitor,7,"trp_caravan_master"),
        (set_visitor,8,"trp_caravan_guard"),
        (set_visitor,9,"trp_nord_female_warrior"),
        (set_visitor,10,"trp_aerys"),#some nobleman
        (set_visitor,11,"trp_tallad"),
        (set_visitor,12,"trp_elaena"),
        (set_visitor,13,"trp_alexis"),
        (set_jump_mission, "mt_gonna_visit_zendar"),
        (assign,"$talk_context",tc_beach_near_zendar),

        (assign,"$dialog_with_alexis",0),
        (jump_to_scene, "scn_start_scene_2"),
        (change_screen_mission),         
       ]),
    ]
  ),
  ...
  ("camp_modding",0,"Select an option:","none",[],#camp option
    [
    ("camp_mod_0",[],"test_castle.",
    [(jump_to_scene,"scn_test_castle"),
     (modify_visitors_at_site, "scn_test_castle"),
          (reset_visitors),
          (set_visitor,13,"trp_askr_undead_warrior_f"),
          (set_visitor,16,"trp_askr_undead_warrior"),
          (set_visitor,17,"trp_skeleton_knight_e"),
          (set_visitor,18,"trp_skeleton_knight_s"),
          (set_visitor,19,"trp_demon_lord"),
          (set_visitor,20,"trp_demon_lord_e"),
          (set_visitor,21,"trp_demon_elite_knight"),
          (set_visitor,22,"trp_demon_high_warrior"),

          (set_visitor,23,"trp_mikhail"),
          (set_visitor,24,"trp_order_knight"),
          (set_visitor,25,"trp_death_knight"),
          (set_visitor,26,"trp_hunger_knight"),
          (set_visitor,27,"trp_conquer_knight"),
          (set_visitor,28,"trp_war_knight"),
          (set_visitor,29,"trp_vags"),
          (set_visitor,30,"trp_feignes"),
          (set_visitor,31,"trp_agnete"),
          (set_visitor,35,"trp_testlady"),
          (set_jump_mission,"mt_town_center"),
          (change_screen_mission),
     ]
  ),
    ("camp_mod_1",[],"Increase player's renown.",
    [(str_store_string,s1,"@Player renown is increased by 150."),
     (call_script,"script_change_troop_renown","trp_player",150),
     (jump_to_menu,"mnu_camp_modding"),
     ]
  ),
    ("camp_mod_2",[],"Increase player's attributes and skills.",
    ...
    ("camp_mod_3",[],"Try to spawn hero army or random.",
    [
     (jump_to_menu,"mnu_camp_call_script"),
     ]
  ),
  ("camp_mod_7",[],"Increase player's honor.",
    [(str_store_string,s1,"@Player honor is increased by 25."),
     (call_script,"script_change_player_honor",-25),
     (jump_to_menu,"mnu_camp_modding"),
     ]
  ),
  ("camp_mod_7",[],"Jump to test scene",
    [
    (jump_to_menu,"mnu_camp_other_scene"),
     ]
  ),
  ("camp_mod_8",[],"change current state",
    [
    (jump_to_menu,"mnu_camp_change_state"),
     ]
  ),
    ("camp_mod_5",[],"Back to camp menu.",
    [(jump_to_menu,"mnu_camp"),
     ]
  ),
  ]),
  ...
  ("camp_other_scene",0,"Select an option:","none",[],#camp option
  [
    ("camp_other_scene_1",[],"test_scene",
    [(jump_to_scene,"scn_test_scene_new"),
    (modify_visitors_at_site, "scn_test_scene_new"),
             (reset_visitors),
        ...
        (try_for_range, ":companion_candidate", companions_begin, companions_end),
             ...
             (try_end),
        (try_begin),#libwe
               (try_for_range, ":tavern_mercenary_intermediary", "trp_alayaya", "trp_deliver"),
               (set_visitor, ":cur_entry", ":tavern_mercenary_intermediary"),
               (val_add, ":cur_entry", 1),
        (try_end),
        (change_screen_mission),
    ...
    ("camp_other_scene_2",[],"test_scene2",
    [(jump_to_scene,"scn_test_scene_new1"),
    (modify_visitors_at_site, "scn_test_scene_new1"),
             (reset_visitors),
             (change_screen_mission),
     ]
  ),
    ("camp_other_scene_3",[],"scn_start_scene_2",
    [
    #   (jump_to_scene,"scn_test_scene_new2"),
    # (modify_visitors_at_site, "scn_test_scene_new2"),
    #          (reset_visitors),
    #          (change_screen_mission),
    (set_jump_mission,"mt_town_center"),
    (jump_to_scene,"scn_start_scene_2"),
    ...
    #          (change_screen_mission),
      ...
      ("camp_other_scene_5",[],"return",
    [(jump_to_menu,"mnu_camp_modding"),
     ]
  ),
  ]),
  ("camp_change_state",0,"Select an option:","none",[],#camp option
  [
    ("camp_change_state_1",[],"glory phase 1",
    [
      (assign,"$glory_main_quest_phase", 1),
      (call_script,"script_start_quest","qst_chaper_one_glory"),
      (call_script,"script_start_quest","qst_find_sister"),
      (call_script,"script_start_quest","qst_visit_zendar"),
    ]
    ),
      ("camp_change_state_5",[],"return",
    [(jump_to_menu,"mnu_camp_modding"),
     ]
  ),
  ]),
  ################
  ("camp_call_script",0,"Select an option:","none",[],#camp option
  [
    ("camp_call_script_1",[],"hero army",
    [
      (call_script,"script_cf_try_spawn_hero_party",0),
    ]
    ),
    ("camp_call_script_2",[],"random spawn",
    [
      (call_script,"script_cf_try_spawn_random_party",0),
    ]
    ),
    ("camp_call_script_3",[],"guard",
    [
      (call_script,"script_try_hire_guard_party"),
    ]
    ),
    ("camp_call_script_4",[],"random hero army",
    [
      (call_script,"script_try_spawn_random_hero_party"),
    ]
    ),
      ("camp_call_script_5",[],"return",
    [(jump_to_menu,"mnu_camp_modding"),
     ]
  ),
  ]),

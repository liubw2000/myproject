...
#       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
  ...
  ("early_transitional_banner", 0, "sample_early_transitional_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_early_transitional_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
  ("mail_long_surcoat_banner", 0, "sample_mail_long_surcoat_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_mail_long_surcoat_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
  ("surcoat_over_mail_banner", 0, "sample_surcoat_over_mail_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_surcoat_over_mail_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("armor_14_banner", 0, "sample_armor_14_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_armor_14_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("agincourtplate_banner", 0, "sample_agincourtplate_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_agincourt_plate_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("guesclin_banner", 0, "sample_guesclin_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_guesclin_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("williamdouglas2_banner", 0, "sample_williamdouglas2_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
      ...
      #  (cur_tableau_add_mesh, ":banner_mesh", pos1, 90, 0),
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_williamdouglas2_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("light_mail_and_plate_banner", 0, "sample_light_mail_and_plate_banner", 512, 512, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_light_mail_and_plate_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("arena_armor_banner", 0, "sample_arena_armor_banner", 512, 512, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_arena_armor_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("arena_tunic_banner", 0, "sample_arena_tunic_banner", 512, 512, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_arena_tunic_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("full_plate_banner", 0, "sample_full_plate_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_full_plate_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ("black_lance_banner", 0, "sample_black_lance_banner", 256, 256, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_black_lance_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
   ("shirt_banner", 0, "sample_shirt_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shirt_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
   ("rus_lamellar_banner", 0, "sample_rus_lamellar_banner", 1024, 1024, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_rus_lamellar_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
   ("battle_flag_d_banner", 0, "sample_battle_flag_d_banner", 256, 256, 0, 0, 0, 0,#libwe
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_battle_flag_d_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
    ############################

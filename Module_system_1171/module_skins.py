...
#     ("manface_old_2",0xffd5d5c5,["hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
    ...
    "shortbob","straightshoulder","maidenhair","longshoulder","longstraight","ponytail","courthair","shortlayer"], #woman_hair_meshes
...
#     ("womanface_midage",0xffe5eaf0,["hair_black","hair_brunette","hair_red","hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
 ...
 (
   "undead", 0,
   "undead_body", "undead_calf_l", "undead_new_handL",
   "undead_head", undead_face_keys,
   ["man_hair_s","man_hair_m","man_hair_n","woman_hair_p","woman_hair_n","woman_hair_o"],#hair
   [],#beard
   ["hair_blonde", "hair_red", "hair_brunette", "hair_black", "hair_white"],#haircolor
   [],#beardcolor
   [("undeadface_a",0xffffffff,["hair_blonde"],[0xff171313, 0xff007080c]),
    ("undeadface_b",0xffcaffc0,["hair_blonde"],[0xff120808, 0xff007080c]),
    ], #undead_face_textures
   [(voice_die,"snd_demon_die"),(voice_hit,"snd_demon_hit"),(voice_yell,"snd_demon_yell"),(voice_victory,"snd_demon_victory")], #voice sounds
   "skel_human", 1.0,
    psys_nothing,psys_nothing,
 ),

 (
    "beauty", skf_use_morph_key_10,
    "woman_body",  "woman_calf_l", "f_handL",
    "corprus_female_head", corprus_female_face_keys ,
    ["woman_hair_p","woman_hair_n","woman_hair_o","woman_hair_q","woman_hair_r","woman_hair_t","woman_hair_s","woman_hair_gaolu_0",
    "shortbob","straightshoulder","maidenhair","longshoulder","longstraight","ponytail","courthair","shortlayer"], #woman_hair_meshes
#    ["woman_hair_a","woman_hair_b","woman_hair_c","woman_hair_d","woman_hair_e","woman_hair_f","woman_hair_g"], #woman_hair_meshes
    [],
    ["hair_blonde", "hair_red", "hair_brunette", "hair_black", "hair_white"], #hair textures
    [],
    [("womanface_b_gaolu",0xffe3e8ef,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
     ("womanface_c_gaolu",0xffdfdfdf,["hair_blonde"],[0xffa5481f, 0xff502a19, 0xff19100c, 0xff0c0d19]),
     ("womanface_young_gaolu",0xffe8dfe5,["hair_blonde"],[0xff502a19, 0xff19100c, 0xff0c0d19]),
...
#     ("manface_old_2",0xffd5d5c5,["hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
 ...
 (
   "demon", 0,
   "demonbody", "demon_calf_l", "Demon_handL",
   "demon_head", undead_face_keys,
   ["demon_horn_1","demon_horn_2","demon_horn_3","demon_horn_5","demon_horn_6","demon_horn_7","demonlord_horn_1","demonlord_horn_2"],#hair
   [],#beard
   ["demon_horn"],#haircolor
   [],#beardcolor
   [("demonface",0xffffffff,["demon_horn"],[0xff171313, 0xff007080c]),
    ], #undead_face_textures
   [(voice_die,"snd_demon_die"),(voice_hit,"snd_demon_hit"),(voice_yell,"snd_demon_yell"),(voice_victory,"snd_demon_victory")], #voice sounds
   "skel_human", 1.22,
    psys_game_blood,psys_game_blood_2,
 ...
 (
   ...
   ["hair_blonde", "hair_red", "hair_brunette", "hair_black", "hair_white"],#haircolor
   [],#beardcolor
   [("barf_skull",0xffffffff,["hair_blonde"],[0xff171313, 0xff007080c]),
    ], #undead_face_textures
   [], #voice sounds
   "skel_human", 1.0,
    psys_nothing,psys_nothing,
 ...
 (
   "succubus", 0,
   "woman_body_new", "demon_calf_l", "f_handL",
   "corprus_female_head", corprus_female_face_keys,
   ["woman_hair_p","woman_hair_n","woman_hair_o","woman_hair_q","woman_hair_r","woman_hair_t","woman_hair_s","woman_hair_gaolu_0",
    "shortbob","straightshoulder","maidenhair","longshoulder","longstraight","ponytail","courthair","shortlayer"],#hair
   [],#beard
   ["hair_blonde", "hair_red", "hair_brunette", "hair_black", "hair_white"],#haircolor
   [],#beardcolor
   [("womanface_b_gaolu",0xffe3e8ef,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
     ...
     ("womanface_brown_gaolu",0xffaf9f7e,["hair_blonde"],[0xff19100c, 0xff0c0d19, 0xff007080c]),
     ("womanface_african_gaolu",0xff808080,["hair_blonde"],[0xff120808, 0xff007080c]),
     ("womanface_caucas_gaolu",0xffe8dfe5,["hair_blonde"],[0xff502a19, 0xff19100c, 0xff0c0d19]),], #woman_face_textures
   [(voice_die,"snd_woman_die"),(voice_hit,"snd_woman_hit"),(voice_yell,"snd_woman_yell")], #voice sounds
   "skel_human", 1.0,
    psys_game_blood,psys_game_blood_2,
 ),

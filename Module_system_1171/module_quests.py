...
##     ),
 ...
 ("collect_men", "Collect Five Men", 0,
  ...
  # ("test_mod","Speak with Geoffey",qf_random_quest,
  # "deal with him.\
  # huanhang huanhang."),

  #glory libwe
  ("chaper_one_glory", "Chaper one", 0,
  "{!}placeholder."
  ), 

  ("find_sister", "find sister", 0,
  "{!}placeholder."
  ), 

  ("find_brother", "find brother", 0,
  "{!}placeholder."
  ), 

  ("visit_zendar", "visit zendar", 0,
  "{!}placeholder."
  ), 

  ("destory_bandit_zendar", "visit zendar", 0,
  "{!}placeholder."
  ), 

  ("destory_sea_raider_zendar", "visit zendar", 0,
  "{!}placeholder."
  ), 

  ("zendar_fight_sea_raider", "visit zendar", 0,
  "{!}placeholder."
  ), 

...
("the_coast", "the coast"),
  ...
  #new quest
  ("start_quest_visit_zendar","start_quest_visit_zendar"),
  ("start_quest_chaper_one_glory","chaper_one_glory"),
  ("start_quest_find_sister","find_sister"),
  ("start_quest_find_brother","find_brother"),
  ...
  ("name_of_brother","name_of_brother"),
  ("name_of_sister","name_of_sister"),
  ...
  ("attribute_int","int"),
  ("attribute_cha","cha"),
  ("see_your_parents","see_your_parents"),
  ...
  ("you_hear_about_calradia","You hear about Calradia, a land torn between rival kingdoms battling each other for supremacy,\
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Calradia and its kingdoms, you..."),
  ("but_soon_everything_changed_and_you","But soon everything changed and you decided to strike out on your own as an adventurer. What made you take this decision was..."),
  ("a_letter_from_your_parent","But soon everything changed and you received a letter from your parents, they seems panic and ask you come back to visit them.\
    # They tell you ready for a long travel, what will you bring with?"),
  ("visit_your_parents","After a long trip, you come back to visit your parents."),
  ("run_for_your_destiny","Become a  run for your destiny."),
  ("trip_to_visit_your_parent","Ready to start a trip to visit your parent."),

  ("take_your_money_and_go","Ready to start a trip to visit your parent."),
  ("take_your_sword_and_go","Ready to start a trip to visit your parent."),
  ("take_your_armor_and_go","Ready to start a trip to visit your parent."),
  ("take_your_goods_and_go","Ready to start a trip to visit your parent."),
  ("take_your_brother_and_go","Ready to start a trip to visit your parent."),
  ("take_your_sister_and_go","Ready to start a trip to visit your parent."),

  ("kill_all_assassin","kill_all_assassin"),
  ("killed_by_assassin","kill_all_assassin"),
  ...
  ("battlefield_extra_large", "Extra large"),
  ## CC
  ...
  #party_name
  #name_askr#random hero name
  ("name_askr_1","Ulfric"),
  ("name_askr_2","Kvasir"),
  ("name_askr_3","Rosegger"),
  ("name_askr_4","Malmo"),
  ("name_askr_5","Modi"),
  ("name_askr_6","Selund"),
  ("name_askr_7","Skinfaxi"),
  ("name_askr_8","Skeling"),
  ("name_askr_9","Thorlaks"),
  ("name_askr_10","Tegner"),
  ("name_askr_11","Tyvidr"),
  ("name_askr_12","Valhalla"),
  ("name_askr_13","Wingnir"),
  ("name_askr_14","Wolfdietrich"),
  ("name_askr_15","Uggerus"),
  #name_regular
  ("name_regular_1","Gerris"),
  ("name_regular_2","Orson"),
  ("name_regular_3","Vargo"),
  ("name_regular_4","Oscar"),
  ("name_regular_5","Constantine"),
  ("name_regular_6","Maruth"),
  ("name_regular_7","Androw"),
  ("name_regular_8","Edrick"),
  ("name_regular_9","Borys"),
  ("name_regular_10","Desmond"),
  ("name_regular_11","Denys"),
  ("name_regular_12","Elbert"),
  ("name_regular_13","Eldridge"),
  ("name_regular_14","Kanstein"),
  ("name_regular_15","Ustanak"),
  ("name_regular_16","Ustanak"),
  ("name_regular_17","Ferumbras"),
  #name_female
  ("name_female_1","Heliburn"),
  ("name_female_2","Marian"),
  ("name_female_3","Ivrine"),
  ("name_female_4","Eimyria"),
  ("name_female_5","Delilah"),
  ("name_female_6","Meg"),
  ("name_female_7","Nienna"),
  ("name_female_8","Mithrellas"),
  ("name_female_9","Lily"),
  ("name_female_10","Rosa"),
  ("name_female_11","Hiril"),
  ("name_female_12","Rosalia"),
  ("name_female_13","Adela"),
  ("name_female_14","Fiona"),
  ("name_female_15","Caroline"),
  ("name_female_16","Rebecca"),
  ("name_female_17","Blaumeux"),
  #name_title_askr#name end
  ("name_title_askr_1","killer"),
  ("name_title_askr_2","darkheart"),
  ("name_title_askr_3","bloodfeed"),
  ("name_title_askr_4","fellomen"),
  ("name_title_askr_5","teen"),
  ("name_title_askr_6","wolffinder"),
  ("name_title_askr_7","giantkiller"),
  ("name_title_askr_8","blood"),
  ("name_title_askr_9","black"),
  ("name_title_askr_10","blood"),
  ("name_title_askr_11","black"),
  ("name_title_askr_12","black"),
  #name_title_regular
  ("name_title_regular_1","undefeat"),
  ("name_title_regular_2","ironskin"),
  ("name_title_regular_3","cold"),
  ("name_title_regular_4","cunning"),
  ("name_title_regular_5","smile"),
  ("name_title_regular_6","storm"),
  ("name_title_regular_7","hunter"),
  ("name_title_regular_8","eater"),
  ("name_title_regular_9","blackwind"),
  ("name_title_regular_10","strong"),
  ("name_title_regular_11","greed"),
  ("name_title_regular_12","brutal"),
  ("name_title_regular_13","blackwind"),
  ("name_title_regular_14","bloodblade"),
  ("name_title_regular_15","shadow"),
  ("name_title_regular_16","shadow"),
  #name_title_dark
  ("name_title_dark_1","darkomen"),
  ("name_title_dark_2","unclean"),
  ("name_title_dark_3","nightmare"),
  ("name_title_dark_4","cunning"),
  ("name_title_dark_5","godhater"),
  ("name_title_dark_6","blood"),
  ("name_title_dark_7","blood"),
  ("name_title_dark_8","blood"),
  ("name_title_dark_9","rustheart"),
  ("name_title_dark_10","darkwatch"),
  ("name_title_dark_11","sonofsin"),
  ("name_title_dark_12","gracegiving"),
  ("name_title_dark_13","cruse"),
  ("name_title_dark_14","darkwhisper"),
  ("name_title_dark_15","blackblade"),
  ("name_title_dark_16","darkthrone"),
  #name_title_female
  ("name_title_female_1","witch"),
  ("name_title_female_2","wolf"),
  ("name_title_female_3","shadow"),
  ("name_title_female_4","cunning"),
  ("name_title_female_5","witch"),
  ("name_title_female_6","sweet"),
  ("name_title_female_7","sad"),
  #hair male=title_end
  ("man_bald","0"),
  ("man_hair_s","1"),
  ("man_hair_m","2"),
  ...
  ("shortlayer","16"),
  #hero army
  ("trp_onsved","trp_onsved"),
  ("trp_wabbaer","trp_wabbaer"),
  ("trp_matheld","trp_matheld"),
  ("trp_firentis","trp_firentis"),
  ("trp_bunduk","trp_bunduk"),
  ("trp_marcus","trp_marcus"),
  ("trp_jerome","trp_jerome"),
  ("trp_ulf","trp_ulf"),
  ("trp_giscard","trp_giscard"),
  ("trp_zandana","trp_zandana"),
  ("trp_world_destoryer","trp_world_destoryer"),
  ("trp_judge_the_highest","trp_judge_the_highest"),
  ("trp_occis","trp_occis"),
  #random
  ("askr_random_army","askr_random_army"),
  ("dark_random_army","dark_random_army"),
  ("outlaw_random_army","outlaw_random_army"),
  #troop specific skill
  ("none_specific","0"),
  ("arrow_block","1"),
  ("never_fear","2"),
  ("rebirth","3"),
  ...
  ("lord_14","14"),
  ("lord_15","15"),
  #traveler information hero
  ("traveler_information_hero_1","1"),
  ("traveler_information_hero_2","2"),
  ("traveler_information_hero_3","3"),
  ("traveler_information_hero_4","4"),
  ("traveler_information_hero_5","5"),
  ("traveler_information_hero_6","6"),
  ("traveler_information_hero_7","7"),
  ("traveler_information_hero_8","8"),
  ("traveler_information_hero_9","giscard"),
  ("traveler_information_hero_10","zandana"),
  ("traveler_information_hero_11","world_destoryer"),
  ("traveler_information_hero_12","12"),
  #traveler information
  ("traveler_information_1","1"),
  ("traveler_information_2","2"),
  ("traveler_information_3","3"),
  ("traveler_information_4","4"),
  ("traveler_information_5","5"),
  ("traveler_information_6","6"),
  ("traveler_information_7","7"),
  ("traveler_information_8","8"),
  ("traveler_information_9","9"),
  #magic
  ("magic_1","1"),
  ("magic_2","2"),
  ("magic_3","3"),
  ...
  ("achievement_13","13"),
  #hero
  ("achievement_hero_1","1"),
  ("achievement_hero_2","2"),
  ("achievement_hero_3","3"),
  ("achievement_hero_4","4"),
  ("achievement_hero_5","5"),
  ("achievement_hero_6","6"),
  ("achievement_hero_7","7"),
  ("achievement_hero_8","8"),
  ("achievement_hero_9","9"),
  ("achievement_hero_10","10"),
  ("achievement_hero_11","11"),
  ("achievement_hero_12","12"),
  ("achievement_hero_13","13"),
  #achievement_txt#achievement_end
  ("achievement_txt_1","1"),
  ("achievement_txt_2","2"),
  ("achievement_txt_3","3"),
  ("achievement_txt_4","4"),
  ...
  ("achievement_txt_8","8"),
  ("achievement_txt_9","9"),
  ("achievement_txt_10","10"),
  ("achievement_txt_11","11"),
  ("achievement_txt_12","12"),
  ("achievement_txt_13","13"),
  #hero
  ("achievement_hero_txt_1","1"),
  ("achievement_hero_txt_2","2"),
  ("achievement_hero_txt_3","3"),
  ("achievement_hero_txt_4","4"),
  ("achievement_hero_txt_5","5"),
  ("achievement_hero_txt_6","6"),
  ("achievement_hero_txt_7","7"),
  ("achievement_hero_txt_8","8"),
  ("achievement_hero_txt_9","9"),
  ("achievement_hero_txt_10","10"),
  ("achievement_hero_txt_11","11"),
  ("achievement_hero_txt_12","12"),
  ("achievement_hero_txt_13","13"),
  #faction dia
  ("wabber_friend","friend"),
  ("spring_friend","friend"),
  #dont change order
  #knight
  ("spring_enemy","enemy"),
  ("witch_enemy_1","enemy"),
  ("witch_enemy_2","enemy"),
  #other
  ("caprine_enemy_1","enemy"),
  ("caprine_enemy_2","enemy"),
  ("looter_enemy_1","enemy"),
  ("looter_enemy_2","enemy"),
  ("looter_enemy_3","enemy"),
  ("looter_enemy_4","enemy"),
  ("looter_enemy_5","enemy"),
  ("looter_enemy_6","enemy"),
  ("looter_enemy_7","enemy"),
  ("looter_enemy_8","enemy"),
  ("starka_enemy","enemy"),
  #evil
  ("roskel_enemy_hero","enemy"),
  ("roskel_enemy_weak","enemy"),
  ("destroyer_enemy_1","enemy"),
  ("destroyer_enemy_2","enemy"),
  ("destroyer_enemy_3","enemy"),
  ("destroyer_enemy_4","enemy"),
  ("destroyer_enemy_5","enemy"),
  #default
  ("default_enemy_1","enemy"),
  ("default_enemy_2","enemy"),
  ("default_enemy_3","enemy"),
  ("default_enemy_4","enemy"),
  ("default_enemy_5","enemy"),
  ("default_defender_1","enemy"),
  ("default_defender_2","enemy"),
  #hero
  ("hero_1","wabbaer"),
  ("hero_2","onsved"),
  ("hero_3","matheld"),
  ...
  ("hero_9","giscard"),
  ("hero_10","zandana"),
  ("hero_11","world_destoryer"),
  ("hero_12","female_adventurer_dis"),
  ("hero_13","judge_the_highest"),
]
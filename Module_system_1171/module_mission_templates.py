  ...
  ti_on_agent_hit, 0, 0, [],
    [
      ...
      (try_begin),
        ...
        (try_begin), # is a horse, if attacked by wild hunt
          (neg|agent_is_human, ":inflicted_agent"), 
          (agent_get_rider, ":human_agent", ":inflicted_agent"),
          (try_for_range,":dest",0,3),
            (store_add,":slot_no",":dest",slot_troop_specific_skill_1),
            (troop_get_slot,":specific_skill",":dealer_troop",":slot_no"),
            (try_begin),
              (eq,":specific_skill","str_wild_hunt"),
        ...
        (try_begin),#if human
          ...
          (try_for_range,":dest",0,3),#dealer_troop
            (store_add,":slot_no",":dest",slot_troop_specific_skill_1),
            (troop_get_slot,":specific_skill",":dealer_troop",":slot_no"),
            (try_begin),
              (eq,":specific_skill","str_hate_heresy"),#hate1
              (try_begin),
                (troop_get_type,":trp_type",":human_troop_no"),#
                (store_faction_of_troop,":faction_no",":human_troop_no"),
                (this_or_next|eq,":trp_type",2),
                (this_or_next|eq,":trp_type",5),
                (this_or_next|eq,":trp_type",6),
                (this_or_next|eq,":trp_type",7),
                (this_or_next|eq,":faction_no","fac_wabber"),
                (this_or_next|eq,":faction_no","fac_caprine"),
                (eq,":faction_no","fac_destroyer"),
                (val_mul,":dest_damage",110),
                (val_div,":dest_damage",100),
              (try_end),
            (else_try),
              (eq,":specific_skill","str_hate_demon"),#demon
              (troop_get_type,":trp_type",":human_troop_no"),
              (this_or_next|eq,":trp_type",6),
              (this_or_next|eq,":human_troop_no","trp_phantom_of_wabbaer"),
              (this_or_next|eq,":human_troop_no","trp_wabbaer_grace_receiver"),
              (eq,":human_troop_no","trp_caprine_dead_wild_hunt_warrior"),
              (val_mul,":dest_damage",120),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_hate_unddead"),#undead
              (is_between,":human_troop_no","trp_undead_walker","trp_undead_end"),
              (val_mul,":dest_damage",120),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_furious"),#furious
              (this_or_next|eq,":specific_skill","str_son_of_starka"),
              (le,":missile_id",0),#not ranged
              (val_mul,":dest_damage",150),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_glass_can"),#glass
              (gt,":missile_id",0),#not ranged
              (val_mul,":dest_damage",150),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_defender"),#30%
              (val_mul,":dest_damage",70),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_hate_bandit"),#outlaw
              (is_between,":human_troop_no","trp_looter","trp_manhunt_squire"),
              (val_mul,":dest_damage",120),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_hate_pagan"),#pagan
              (store_faction_of_troop,":faction_no",":human_troop_no"),
              (neq,":faction_no","fac_gulfod_theocracy"),
              (neq,":faction_no","fac_seven_god"),
              (neq,":faction_no","fac_witch_finder"),
              (neq,":faction_no","fac_dragon_knight"),
              (neq,":faction_no","fac_spring_knight"),
              (neq,":faction_no","fac_demon_hunter"),
              (neq,":faction_no","fac_kingdom_1"),
              (neq,":faction_no","fac_kingdom_5"),
              (neq,":faction_no","fac_kingdom_7"),
              (val_mul,":dest_damage",110),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_highly_skilled"),#highly_skilled
              (le,":missile_id",0),#not ranged
              (store_random_in_range,":ran",0,10),
              (eq,":ran",0),
              (val_mul,":dest_damage",2),
            (else_try),
              (eq,":specific_skill","str_blood_drinker"),#blood_drinker
              (le,":missile_id",0),#not ranged
              (store_agent_hit_points,":cur_hitpoint",":dealer_agent",1),
              (assign,":blood",":dest_damage"),
              (val_div,":blood",8),
              (val_min,":blood",5),
              (val_add,":cur_hitpoint",":blood"),
              (agent_set_hit_points, ":dealer_agent",":cur_hitpoint",1),
            (else_try),
              (eq,":specific_skill","str_blood_frenzy"),#blood_frenzy
              (le,":missile_id",0),#not ranged
              (store_agent_hit_points,":cur_hitpoint",":dealer_agent"),
              (store_sub,":modfi",200,":cur_hitpoint"),
              (val_mul,":dest_damage",":modfi"),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_killer_skill"),#killer_skill
              (le,":missile_id",0),#not ranged
              (agent_get_slot,":defeat_num",":dealer_agent",slot_agent_defeat_enemy_num),
              (val_max,":defeat_num",0),
              (val_min,":defeat_num",10),
              (val_mul,":defeat_num",10),
              (val_add,":defeat_num",100),
              (val_mul,":dest_damage",":defeat_num"),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_lord_12"),#lord
              (val_mul,":dest_damage",200),
              (val_div,":dest_damage",100),
            (try_end),
          (try_end),          

          (try_for_range,":dest",0,3),#inflicted_troop
            (store_add,":slot_no",":dest",slot_troop_specific_skill_1),
            (troop_get_slot,":specific_skill",":human_troop_no",":slot_no"),
            (try_begin),
              (eq,":specific_skill","str_ebony_skin"),#20%
              (val_mul,":dest_damage",80),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_dragon_skin"),#40%
              (val_mul,":dest_damage",60),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_stone_skin"),#10%
              (val_mul,":dest_damage",90),
              (val_div,":dest_damage",100),
            (else_try),
              (this_or_next|eq,":specific_skill","str_initiate_fear"),#30%
              (eq,":specific_skill","str_son_of_starka"),
              (val_mul,":dest_damage",70),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_furious"),#50%
              (val_mul,":dest_damage",150),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_glass_can"),#glass
              (gt,":missile_id",0),#ranged
              (val_mul,":dest_damage",200),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_defender"),#30%
              ...
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_holy_protection"),#90%
              (val_mul,":dest_damage",10),
              (val_div,":dest_damage",100),
            (else_try),
              (eq,":specific_skill","str_escape"),#10%
              (le,":missile_id",0),#ranged
              (store_random_in_range,":des",0,10),
              (eq,":des",1),
              (assign,":dest_damage",0),
            (else_try),
              (eq,":specific_skill","str_arrow_block"),#10%
              (gt,":missile_id",0),#ranged
              (store_random_in_range,":des",0,10),
              (eq,":des",1),
              (assign,":dest_damage",0),
            (else_try),
              (eq,":specific_skill","str_blade_immunity"),#100%
              (assign,":dest_damage",0),
            (else_try),
              (eq,":specific_skill","str_arrow_immunity"),#100%
              (gt,":missile_id",0),#ranged
              (assign,":dest_damage",0),
            (else_try),
              (eq,":specific_skill","str_lord_12"),#lord
              (val_mul,":dest_damage",50),
              (val_div,":dest_damage",100),
            (try_end),
          (try_end),

          (try_begin),
            (store_skill_level,":ironflesh","skl_ironflesh",":human_troop_no"),#skl_ironflesh
            (val_mul,":ironflesh",2),
            (try_begin),
              (is_between,":human_troop_no","trp_wabbaer","trp_constable_hareck"),#reduce more for hero
              (val_mul,":ironflesh",2),
            (try_end),
            (store_sub,":reduce",100,":ironflesh"),
            (val_mul,":dest_damage",":reduce"),
            (val_div,":dest_damage",100),
          (try_end),

          (try_begin),
            (eq,":weapon_id","itm_pistol_for_test"),
            (store_agent_hit_points, ":merchant_hp",":inflicted_agent",1),
            (assign,reg22,":merchant_hp"),
            (display_message,"@hp:{reg22}"),
          (try_end),

          #start compute magic damage
          (try_begin),
          (gt,":weapon_id",0),
          (item_get_slot,":magic_power",":weapon_id",slot_item_magic_power),
          (gt,":magic_power",0),
            (try_begin),#do magic damage
              (gt,":missile_id",0),
              (item_get_slot,":magic_damage",":missile_id",slot_item_magic_power),
              (val_mul,":magic_damage",":magic_power"),
              (val_div,":magic_damage",100),
            (else_try),
              (assign,":magic_damage",":magic_power"),
            (try_end),

            (call_script,"script_calculate_magic_damage",":dealer_troop",":human_troop_no"),
            (assign,":magic_damage_mod",reg0),
            (val_mul,":magic_damage",":magic_damage_mod"),
            (val_div,":magic_damage",100),
            (val_add,":dest_damage",":magic_damage"),
          (try_end),

          #fire damage
          (try_begin),
            (eq,":weapon_id","itm_caveirabastard_magic"),
            (val_add,":dest_damage",12),
          (else_try),
            (eq,":weapon_id","itm_flamberge1"),
            (val_add,":dest_damage",10),
          (try_end),
...
common_horse_archer_enhance = (
  3, 0, 0, [],
  [      
        (set_fixed_point_multiplier, 1000),
        (eq,"$horse_archer_enhance",1),
        (try_for_agents, ":agent_no"),
            (agent_is_alive, ":agent_no"),
            (agent_is_human, ":agent_no"),
...
dedal_tavern_animations = (#new
        ti_on_agent_spawn,1,0,[
                ...
                (else_try),
                        ...
                        (agent_set_animation_progress,":agent",":r"),
                (else_try),
                        (this_or_next|is_between,":troop",walkers_begin,walkers_end),
                        (is_between,":troop","trp_black_khergit_horseman","trp_black_khergit_horseman_leader"),
                        (try_begin),
...
common_siege_refill_ammo = (
  ...
  [#refill ammo of defenders every two minutes.
    # (get_player_agent_no, ":player_agent"),
    (try_for_agents,":cur_agent"),
      # (neq, ":cur_agent", ":player_agent"),#new#libwe
      (agent_is_alive, ":cur_agent"),
      (agent_is_human, ":cur_agent"),
...
common_siege_check_defeat_condition = (
  1, 4, ti_once, [(main_hero_fallen),#new
                  (assign,":continue",1),
                  (try_for_agents,":cur_agent"),
                  (agent_is_alive, ":cur_agent"),
                  (agent_is_human, ":cur_agent"),
...
mission_templates = [
  (
    ...
    common_init_item_in_battle,#test
    common_init_item_slot,
    common_open_inv_refill_ammmo,
...
#-----------------------------------------------------------------
  ...
  (
    ...
    [
      ...
      [
          (get_player_agent_no, ":agent_no"),#libwe
        (try_for_range,":inv_no",0,4),
          (agent_get_item_slot,":cur_item",":agent_no",":inv_no"),
          (gt,":cur_item",0),
          (item_get_type,":cur_item_type",":cur_item"),
          ...
          (agent_set_ammo,":agent_no",":item_no",":ammo"),
          (agent_set_slot,":agent_no",":slot_weapon_changed",0),
          (agent_set_slot,":agent_no",slot_agent_last_weild_weapon,"itm_red_tourney_armor"),
        (try_end),
        ]),
   ...
   [
     ...
     (agent_get_troop_id, ":killer_agent_troop_no", ":killer_agent_no"),
        ...
        (try_begin),#new#mod
          (agent_get_slot,":defeat_num",":killer_agent_no",slot_agent_defeat_enemy_num),
          (val_add,":defeat_num",1),
          (agent_set_slot,":killer_agent_no",slot_agent_defeat_enemy_num,":defeat_num"),
        (try_end),
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (1,mtef_defenders|mtef_team_0,0,aif_start_alarmed,24,[]),
     (0,mtef_defenders|mtef_team_0,0,aif_start_alarmed,0,[]),
     (4,mtef_attackers|mtef_team_1,0,aif_start_alarmed,24,[]),
      ...
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (try_begin),#new
          ...
          (agent_get_troop_id,":lead_troop_id",":leader"),
          (this_or_next|troop_slot_eq,":lead_troop_id",slot_troop_specific_skill_1,"str_lord_5"),
          (this_or_next|troop_slot_eq,":lead_troop_id",slot_troop_specific_skill_2,"str_lord_5"),
          (troop_slot_eq,":lead_troop_id",slot_troop_specific_skill_3,"str_lord_5"),
         ...
         (try_begin),#new
          (this_or_next|troop_slot_eq,":troop_id",slot_troop_specific_skill_1,"str_random_1"),
          (this_or_next|troop_slot_eq,":troop_id",slot_troop_specific_skill_2,"str_random_1"),
          (troop_slot_eq,":troop_id",slot_troop_specific_skill_3,"str_random_1"),
          (val_sub,":initial_courage_score",2500),
         (try_end),
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (3, 0, 0, [
          (try_for_agents, ":agent_no"),
            ...
            (agent_get_troop_id,":cur_troop",":agent_no"),#libwe,for undead and demon
            (neg|is_between,":cur_troop","trp_undead_walker","trp_undead_end"),
            (troop_get_type,":trp_type",":cur_troop"),
            (neq,":trp_type",6),

            (try_for_range,":dest",0,3),
              (store_add,":slot_no",":dest",slot_troop_specific_skill_1),
              (troop_get_slot,":specific_skill",":cur_troop",":slot_no"),
              (this_or_next|eq,":specific_skill","str_immunity_to_control"),
              (this_or_next|eq,":specific_skill","str_furious"),
              (this_or_next|eq,":specific_skill","str_never_fear"),
              (eq,":specific_skill","str_just_dont_care"),
              (assign,":continue",0),
            (try_end),
    ...
    [
      ...
      (1, 4, ti_once, [(main_hero_fallen),#new
          ...
          [
              ...
              (call_script, "script_count_mission_casualties_from_agents"),
              (finish_mission, 0)]),
      (ti_before_mission_start,0,0,[],[(replace_scene_props, "spr_player_chest", "spr_locked_player_chest"),]),
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (3,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,24,[]),
     (3,mtef_defenders|mtef_team_0,0,aif_start_alarmed,0,[]),
     (1,mtef_attackers|mtef_team_1,0,aif_start_alarmed,24,[]),
...
##  ),
  ...
  (
    ...
    "You attack the walls of the castle...",
    [
     (0,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,24,[]),
  ...
  (
    ...
    [
     ...
     (11,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,14,[]),
...
#INVASION MODE END
  ...
  (
    ...
    [
      ...
      (ti_on_agent_spawn, 0, 0, [],
      [              
        (store_trigger_param_1, ":agent_no"),#spawn agent
        (get_player_agent_no, ":player_agent"),
        (neq, ":agent_no", ":player_agent"),
...
#new libwe glory
(
    "assassin_attack_1", 0, -1,
    "Assassin attack.",
    [
      (0,mtef_team_0|mtef_use_exact_number,af_override_horse,aif_start_alarmed,10,[]),
      (3,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),
      (5,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),
      (6,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),#regular
      (10,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),
      (11,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),
      (12,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),
      (13,mtef_visitor_source|mtef_team_0,af_override_horse,0,10,[]),

      (1,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,10,[]),
      (2,mtef_visitor_source,af_override_horse,aif_start_alarmed,1,[]),
      (4,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,10,[]),
      (7,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,10,[]),
      (9,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,10,[]),
    ...
    [
      ...
      [
        ...
        (try_for_agents, ":agent_no"),
  	    (agent_get_troop_id, ":agent_troop_id", ":agent_no"),
  	    (this_or_next|eq, ":agent_troop_id", "trp_masked_man"),
  	    (eq, ":agent_troop_id", "trp_mercenary_assassin"),
  	    (agent_set_team, ":agent_no", 1),
        (assign,"$assassin_attack",1),
  	    (else_try),  
        (agent_set_team, ":agent_no", 0),
        (try_end),
      ]),
    ...
    (1, 4, 0,
       ...
       [         
         (try_begin),
           (main_hero_fallen),
           (assign, "$kill_all_assassin", 0),
         (else_try),  
           (assign, "$kill_all_assassin", 1),
         (try_end),
    ...
    # (0, 0, ti_once,
    #    [(eq,"$mother_start_talk",1),
    #    ],
    #    [         
    #     (try_for_agents,":agent_no"),
    #     (agent_get_troop_id,":cur_troop",":agent_no"),
    #     (eq,":cur_troop","trp_mother"),
    #     (agent_get_position,pos5,":agent_no"),
    #     (mission_cam_set_position,pos5),
    #     (try_end),
    #    ]),         
      ...
      (0, 0, ti_once,
       ...
       [         
        (add_visitors_to_current_scene,2,"trp_mercenary_assassin",2),
        (add_visitors_to_current_scene,4,"trp_mercenary_assassin",2),
        (add_visitors_to_current_scene,7,"trp_mercenary_assassin",1),
        (add_visitors_to_current_scene,1,"trp_mercenary_assassin",1),
        (add_visitors_to_current_scene,14,"trp_mercenary_assassin",1),
        (add_visitors_to_current_scene,9,"trp_masked_man",1),
       ]),         
  ...
  (
    ...
    [
      ...
      (ti_before_mission_start, 0, 0, [], 
      [      
        (str_store_troop_face_keys,s0,"trp_player"),
        (str_store_troop_face_keys,s1,"trp_father"),
        (str_store_troop_face_keys,s2,"trp_mother"),
        (face_keys_get_skin_color,":face_key",s0),
        (face_keys_set_skin_color,s1,":face_key"),
        (face_keys_set_skin_color,s2,":face_key"),
        (troop_set_face_keys,"trp_mother",s2),
        (troop_set_face_keys,"trp_father",s1),
	  ]),
      ...
      [ 
        (try_begin),          
          (gt, "$dialog_with_alexis", 0),          

          (assign, ":max_dist", 0),
          (party_get_position, pos1, "p_village_30"),
          (try_for_range, ":unused", 0, 10),
            (map_get_random_position_around_position, pos0, pos1, 2),
            (get_distance_between_positions, ":dist", pos0, pos1),
            (ge, ":dist", ":max_dist"),

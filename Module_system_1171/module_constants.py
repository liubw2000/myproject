...
slot_agent_defeat_enemy_num          = 43
########################################################
##  FACTION SLOTS          #############################
########################################################
...
#libwe#Faction nobleman
slot_faction_nobleman = 101
slot_faction_patrol_leader = 102
slot_faction_rela_can_chan = 103
# slot_faction_flag_holder = 104
#diplomacy
...
slot_center_mercenary_intermediary       = 101
...
#put it down to add new building
slot_center_has_manor            = 251 #village
slot_center_has_fish_pond        = 252 #village
slot_center_has_watch_tower      = 253 #village
slot_center_has_school           = 254 #village
slot_center_has_inn              = 255 #village#new start
slot_center_has_hunter_hut       = 256 #village
slot_center_has_trade_station    = 257 #village

slot_center_has_messenger_post   = 258 #town, castle, village
slot_center_has_patrol_station   = 259 #town, castle, village#new

slot_center_has_prisoner_tower   = 260 #town, castle

slot_center_has_square   = 261 #town
slot_center_has_theater  = 262 #town
slot_center_has_college  = 263 #town
slot_center_has_church   = 264 #town
slot_center_has_manhunter_union   = 265 #town

village_improvements_begin = slot_center_has_manor
village_improvements_end          = 260

walled_center_improvements_begin = slot_center_has_messenger_post
walled_center_improvements_end               = 266

slot_center_has_patrol_party   = 266 #new#libwe

slot_center_has_mafia1   = 267 #mafia1
slot_center_has_mafia2   = 268 #mafia2
slot_center_has_mafia3   = 269 #mafia3
slot_center_has_mafia4   = 270 #mafia4
slot_center_has_mafia5   = 271 #mafia5
slot_center_has_mafia6   = 272 #mafia6

slot_town_seneschal     = 273 #seneschal
slot_center_stability   = 274 #stability
slot_chaos_corruption   = 275 #corruption
...
# libwe new
slot_troop_hold_items                   = 157 #repair item
slot_troop_hold_items_time              = 158
slot_troop_merchant_num                 = 159								
slot_troop_guard_party                 = 160										

slot_troop_specific_skill_1                 = 166
slot_troop_specific_skill_2                 = 167								
slot_troop_specific_skill_3                 = 168		
slot_troop_culture                 			= 169	
slot_hero_specical_weapon         			= 170
########################################################
##  PLAYER SLOTS           #############################
########################################################
...
tc_beach_near_zendar          = 22#libwe
tc_common_guard_talk          = 23
tc_zendar_tavern          = 22#libwe

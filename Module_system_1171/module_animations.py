...
#  ],
#jacobhinds edit begin
 ["stand_single", 0, amf_client_prediction,
   [10.0, "sword_loop01", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [10.0, "sword_loop02", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ...
 ["stand_greatsword", 0, amf_client_prediction,
   [7.0, "greatsword_cstance", 0, 85, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
  #  [8.0, "attacks_twohanded_overswing", 24, 24, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
  #  [8.0, "pike_loop01", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
  #  [8.0, "pike_loop02", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_staff", 0, amf_client_prediction, 
   [7.0, "greatsword_cstance", 0, 85, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [8.0, "pike_loop01", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0],
   [8.0, "pike_loop02", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0],
   [8.0, "pike_loop04", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0],
   [8.0, "pike_loop05", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0],
   [2.0, "staff_cstance", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
 ],
#jacobhinds edit end
...
#jacobhinds edit begin
 ["ride_0", acf_enforce_lowerbody, amf_client_prediction,
   [15.0, "stand_onhorse", 0, 456, arf_cyclic],
   [22.0, "stand_onhorse_sword", 0, 456, arf_cyclic],
  ],
#jacobhinds edit end
...
#  ],
#jacobhinds edit begin
 ["ride_4", acf_enforce_lowerbody | acf_synch_with_horse, amf_use_cycle_period | amf_client_prediction,
   [2.0, "new_ride_4a", 0, 15, arf_cyclic|arf_blend_in_32],  
   [2.0, "new_ride_4d", 0, 15, arf_cyclic|arf_blend_in_32], 
   [2.0, "new_ride_4e", 0, 15, arf_cyclic|arf_blend_in_32],
   [2.0, "anim_human_02", 150, 165, arf_cyclic|arf_blend_in_32], 
 ],
#jacobhinds edit end

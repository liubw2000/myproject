      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        (try_begin),
          ...
          (val_add, "$g_presentation_page_no", 1),
          (val_mod, "$g_presentation_page_no", 10),
...
##        (gt, ":total_wage", 0),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    ("troop_note", 0, 0,[
      ...
      [ 
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        (call_script,"script_mouse_fix_pos_ready"),#just
        ...
        # #back to main
        # (create_game_button_overlay, "$g_presentation_obj_5", "@Main_tree"),
        # (position_set_x, pos1, 900),
        # (position_set_y, pos1, 75),
        # (overlay_set_position, "$g_presentation_obj_5", pos1),
        # #back to another
        # (create_game_button_overlay, "$g_presentation_obj_6", "@Secondary"),
        # (position_set_x, pos1, 900),
        # (position_set_y, pos1, 125),
        # (overlay_set_position, "$g_presentation_obj_6", pos1),
        # #back to another
        # (create_game_button_overlay, "$g_presentation_obj_4", "@hero_troop"),
        # (position_set_x, pos1, 900),
        # (position_set_y, pos1, 175),
        ...
        (try_for_range, ":i_slot", 0, 10),
          (troop_get_inventory_slot, ":item", "trp_temp_array_a", ":i_slot"),#get inventory of troop
          (troop_get_inventory_slot_modifier, ":cur_imod", "trp_temp_array_a", ":i_slot"),
          (gt, ":item", -1),#not empty
          (troop_add_item,"trp_temp_array_a",":item", ":cur_imod"),
          (troop_set_inventory_slot, "trp_temp_array_a", ":i_slot", -1),#set temp_array_a empty
        (try_end),
        ## get the troop
        ...
        (try_end),
        (create_game_button_overlay, "$g_presentation_obj_8", "@CHEAT: spawn the troop"),
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 125),
        ...
        (store_faction_of_troop,":fac_no",":selected_troop"),
        (str_store_faction_name,s2,":fac_no"),
        (str_store_string, s1, "@{s1}^faction:{s2}"),
        ...
        (try_begin),
          (troop_is_hero,":selected_troop"),
          (troop_get_slot,":troop_no",":selected_troop",slot_lord_personal_troop),
          (ge,":troop_no",1),
          (str_store_troop_name,s2,":troop_no"),
          (str_store_string, s1, "@personal:{s2}"),
          (create_text_overlay, reg0, "@{s1}", tf_double_space),
          (position_set_x, pos1, 560),
          (position_set_y, pos1, 610),
          (overlay_set_position, reg0, pos1),
        ...
        #specific skill
        (str_store_string,s1,"@specific_skill"),
        (try_for_range,":dest",0,3),
          (store_add,":slot_no",":dest",slot_troop_specific_skill_1),
          (troop_get_slot,":specific_skill",":selected_troop",":slot_no"),
          (try_begin),
            (gt,":specific_skill",0),
            (str_store_string,s2,":specific_skill"),
        ...
        (try_for_range, ":cur_attribute_no", 0, 4),
          ...
          (create_text_overlay, reg1, "@{s1}:{reg0}",tf_left_align),
          (try_begin),
            (eq, ":cur_attribute_no", 0),
            (assign, ":text_x", ":base_x"),
            (assign, ":text_y", ":base_y"),
          (else_try),
            (eq, ":cur_attribute_no", 1),
            (assign, ":text_x", ":base_x"),
            (store_sub, ":text_y", ":base_y", 16),
          (else_try),
            (eq, ":cur_attribute_no", 2),
            (store_add, ":text_x", ":base_x", 75),
            (assign, ":text_y", ":base_y"),
          (else_try),
        ...
        (overlay_set_position, reg1, pos1),
        (val_sub, ":pos_y", 30),
        (try_for_range_backwards, ":skill_no", "skl_trade", "skl_reserved_18"), # 8 skills
          (neq, ":skill_no", "skl_reserved_1"),
          (neq, ":skill_no", "skl_reserved_2"),
          (neq, ":skill_no", "skl_reserved_3"),
          (neq, ":skill_no", "skl_reserved_4"),
          (neq, ":skill_no", "skl_reserved_7"),
          (neq, ":skill_no", "skl_reserved_8"),
          (neq, ":skill_no", "skl_reserved_9"),
          (neq, ":skill_no", "skl_reserved_10"),
          (neq, ":skill_no", "skl_reserved_11"),
          (neq, ":skill_no", "skl_reserved_12"),
          (neq, ":skill_no", "skl_reserved_13"),
          (neq, ":skill_no", "skl_reserved_14"),
          (neq, ":skill_no", "skl_reserved_15"),
          (neq, ":skill_no", "skl_reserved_16"),
          (neq, ":skill_no", "skl_reserved_17"),
          (neq, ":skill_no", "skl_reserved_18"),
          # name and level
          (assign,":skill_str_no",":skill_no"),
          (store_add, ":dest_text", "str_skl_trade", ":skill_str_no"),
          (str_store_string, s1, ":dest_text"),
        ...
        (assign, ":pos_x", 560),
        (assign, ":pos_y", 500),
        (create_text_overlay, reg1, "@Proficiency", tf_left_align),
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg1, pos1),
        (val_sub, ":pos_y", 20),
        
        # (store_add,":prof_add_1",wpt_firearm,1),
        (try_for_range,":cur_prof",wpt_one_handed_weapon,7),
          (store_add,":dest_text",":cur_prof","str_wpt_one_handed_weapon"),
          (str_store_string, s1, ":dest_text"),
          (store_proficiency_level,":prof_level",":selected_troop",":cur_prof"),
          (assign, reg2, ":prof_level"),
          (create_text_overlay, reg1, "@{s1}:{reg2}", tf_left_align),
          (position_set_x, pos1, ":pos_x"),
          (position_set_y, pos1, ":pos_y"),
          (overlay_set_position, reg1, pos1),
          (position_set_x, pos1, 900),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (else_try),
          ...
          (try_begin),
            (troop_is_hero,":selected_troop"),
            (party_add_members, "p_main_party", ":selected_troop", 1),
          (else_try),
            (party_add_members, "p_main_party", ":selected_troop", 5),
            (str_store_troop_name_plural, s1, ":selected_troop"),
            (display_message, "@CHEAT! You get 5 {s1}.", 0xFF0000),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_8"),
          (spawn_around_party,"p_main_party","pt_deserters"),
          (assign,":new_party",reg0),
          (party_add_members,":new_party",":selected_troop",50),
          (display_message, "@CHEAT! spawn deserters.", 0xFF0000),
        (try_end),
    ]),
    (ti_on_presentation_run,#just
    [
      (call_script,"script_mouse_fix_pos_run"),
    ]),
        ]),

    # troop_updatetroop_tree_recursive_backtracking"and"prsnt_line
    ("faction_upgrade_trees", 0, 0, [
      ...
      [
        ...
        (try_for_range, ":cur_troop", "trp_swadian_recruit", "trp_askr_recruit"),#kingdoms soldiers
          (neg|troop_is_hero, ":cur_troop"),
          # can upgrade
          (troop_get_upgrade_troop, ":upgrade_troop", ":cur_troop", 0),
          (this_or_next|eq,"$show_all_troop",1),
          (gt, ":upgrade_troop", 0),
          # faction
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":slot_no", 0, "$g_cur_slot_no"),
          ...
          (assign, "$g_presentation_next_presentation", "prsnt_faction_upgrade_trees"),
  ...
  ("faction_upgrade_trees_1", 0, 0, [
      ...
      [
        ...
        (store_add, ":selected_faction", "fac_manhunters", "$temp"),
        ...
        (overlay_set_position, "$g_presentation_obj_1", pos1),
        # factions
        (store_sub, ":num_factions","fac_faction_end", "fac_manhunters"),
        (val_add, ":num_factions", 3),
        (try_for_range_backwards, ":i_upgrade_tree", 0, ":num_factions"),
        (store_add, ":faction_no", ":i_upgrade_tree", "fac_manhunters"),
          ## faction name
          (try_begin),
            (eq, ":faction_no", "fac_faction_end"),
            (str_store_string, s0, "@Mercenary"),
          (else_try),
            (eq, ":faction_no", "fac_outlaws_1"),
            (str_store_string, s0, "@Outlaws"),
          (else_try),
            (eq, ":faction_no", "fac_others_1"),
            (str_store_string, s0, "@Others"),
          (else_try), # faction
            (is_between, ":faction_no", "fac_manhunters", "fac_faction_end"),
            (str_store_faction_name, s0, ":faction_no"),
          (try_end),
          (overlay_add_item, "$g_presentation_obj_1", s0),
        (try_end),
        ...
        (assign, reg2, 100),
        # find all root troops of selected faction
        (try_for_range, ":cur_troop", soldiers_begin, soldiers_end),#all
          (neg|troop_is_hero, ":cur_troop"),
          # can upgrade
          (troop_get_upgrade_troop, ":upgrade_troop", ":cur_troop", 0),
          (this_or_next|eq,"$show_all_troop",1),
          (gt, ":upgrade_troop", 0),
          #not kingdom solider
          (neg|is_between, ":cur_troop","trp_swadian_recruit","trp_askr_recruit"),
          # faction
          (assign, ":troop_dest_faction", "fac_others_1"), # Default faction: Others
          (store_troop_faction, ":troop_faction", ":cur_troop"),
          (try_begin),
            (is_between, ":cur_troop", soldiers_begin, mercenary_troops_end),
            (assign, ":troop_dest_faction", "fac_faction_end"), # Mercenary
          (else_try),
            (is_between, ":cur_troop", "trp_looter", "trp_manhunt_squire"),
            (assign, ":troop_dest_faction", "fac_outlaws_1"), # Outlaws
          (else_try),
            (is_between, ":troop_faction", "fac_manhunters", "fac_faction_end"),
            (assign, ":troop_dest_faction", ":troop_faction"),
          (try_end),
          (eq, ":troop_dest_faction", ":selected_faction"),
          # can't be upgraded from other troops
          ...
          (try_for_range, ":loop_troop", soldiers_begin, ":end_cond"),
            (neg|troop_is_hero, ":loop_troop"),
            # loop troop faction
            (assign, ":loop_troop_dest_faction", "fac_others_1"), # Default faction: Others
            (store_troop_faction, ":loop_troop_faction", ":loop_troop"),
            (try_begin),
              (is_between, ":loop_troop", soldiers_begin, mercenary_troops_end),
              (assign, ":loop_troop_dest_faction", "fac_faction_end"), # Calradic Empire mercenary
            (else_try),
              (is_between, ":loop_troop", "trp_looter", "trp_manhunt_squire"),
              (assign, ":loop_troop_dest_faction", "fac_outlaws_1"), # Outlaws
            (else_try),
              (is_between, ":loop_troop_faction",  "fac_manhunters", "fac_faction_end"),
              (assign, ":loop_troop_dest_faction", ":loop_troop_faction"),
            (try_end),
            (eq,  ":loop_troop_dest_faction", ":selected_faction"),
            (troop_get_upgrade_troop, ":upgrade_troop_1", ":loop_troop", 0),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":slot_no", 0, "$g_cur_slot_no"),
          ...
          (troop_get_slot, ":selected_troop", "trp_temp_array_b", ":slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (assign, "$g_presentation_next_presentation", "prsnt_faction_upgrade_trees_1"),
          (start_presentation, "prsnt_troop_note"),
        (try_end),
  ...
  ("hero_note", 0, 0, [
      ...
      [
        ...
        (store_add, ":selected_faction",kingdoms_begin, "$temp"),
        ...
        (overlay_set_position, "$g_presentation_obj_1", pos1),
        # factions
        (store_sub, ":num_factions", npc_kingdoms_end, kingdoms_begin),
        (val_add, ":num_factions", 3),

        (assign,":inac_fac_num",0),
        (try_for_range,":cur_kingdom",kingdoms_begin,kingdoms_end),
          (faction_slot_eq,":cur_kingdom", slot_faction_state,sfs_inactive),
          (val_sub,":num_factions",1),
          (val_add,":inac_fac_num",1),
        (try_end),
        ...
        (try_for_range_backwards, ":i_upgrade_tree", 0, ":num_factions"),
          ...
          ## faction name
          (try_begin),
          (store_sub,":cur_num",":num_factions",2),
            (val_add,":cur_num",kingdoms_begin),
            (eq, ":faction_no", ":cur_num"),
            (str_store_string, s0, "@NPC"),
          (else_try),
            (store_sub,":cur_num",":num_factions",1),
            (val_add,":cur_num",kingdoms_begin),
            (eq, ":faction_no", ":cur_num"),
            (str_store_string, s0, "@Adventurer"),
          (else_try),
            (store_add,":cur_num",":num_factions",kingdoms_begin),
            (eq, ":faction_no", ":cur_num"),
            (str_store_string, s0, "@Hero"),
          (else_try), # kingdoms
            (is_between, ":faction_no", kingdoms_begin, npc_kingdoms_end),
            (neg|faction_slot_eq,":faction_no", slot_faction_state,sfs_inactive),
            (str_store_faction_name, s0, ":faction_no"),
          (try_end),
          (overlay_add_item, "$g_presentation_obj_1", s0),
        (try_end),
        ...
        (assign, "$g_cur_slot_no", 0),
        (try_for_range_backwards, ":cur_troop", "trp_alayen","trp_constable_hareck"),#hero
          (troop_is_hero, ":cur_troop"),
          (neg|is_between,":cur_troop","trp_heroes_end","trp_wabbaer"),
          (neq,":cur_troop","trp_knight_1_1_wife"),
          # faction
          (store_troop_faction, ":troop_faction", ":cur_troop"),
          (assign,":continue",1),
          (try_begin),#original_faction
            (is_between,":cur_troop","trp_kingdom_1_lord","trp_heroes_end"),
            (troop_get_slot,":o_faction",":cur_troop",slot_troop_original_faction),
            (assign,":troop_faction",":o_faction"),
            (try_begin),
              (faction_slot_eq,":troop_faction", slot_faction_state,sfs_inactive),
              (assign,":continue",0),
            (try_end),
          (try_end),
          (eq,":continue",1),
          ...
          (try_begin),
          (store_sub,":cur_num",":num_factions",3),
            (val_add,":cur_num",kingdoms_begin),
            (is_between, ":cur_troop", "trp_npc1", "trp_kingdom_1_lord"),
            (assign, ":troop_dest_faction", ":cur_num"), # Npc
          (else_try),
            (store_sub,":cur_num",":num_factions",2),
            (val_add,":cur_num",kingdoms_begin),
            (is_between, ":cur_troop", "trp_alayen", "trp_npc1"),
            (assign, ":troop_dest_faction", ":cur_num"), # Adventurer
          (else_try),
            (store_sub,":cur_num",":num_factions",1),
            (is_between, ":cur_troop", "trp_wabbaer", "trp_constable_hareck"),
            (val_add,":cur_num",kingdoms_begin),
            (assign, ":troop_dest_faction", ":cur_num"), # Hero
          (else_try),
            (is_between, ":troop_faction", kingdoms_begin, npc_kingdoms_end),
            (neg|faction_slot_eq,":troop_faction", slot_faction_state,sfs_inactive),
            (assign, ":troop_dest_faction", ":troop_faction"),
            (val_add,":troop_dest_faction",2),
            (try_for_range,":other_fac",kingdoms_begin,kingdoms_end),
              (faction_slot_eq,":other_fac", slot_faction_state,sfs_inactive),#if inactive,
              (val_sub,":troop_dest_faction",1),
            (try_end),
          (try_end),
          (eq, ":troop_dest_faction", ":selected_faction"),
          
          (assign,":troop_no",":cur_troop"),

          (try_begin),
            (this_or_next|eq,":troop_no","trp_kingdom_6_lady_20"),#lady first
            (this_or_next|eq,":troop_no","trp_kingdom_5_lady_20"),
            (this_or_next|eq,":troop_no","trp_kingdom_4_lady_20"),
            (this_or_next|eq,":troop_no","trp_kingdom_3_lady_20"),
            (this_or_next|eq,":troop_no","trp_kingdom_2_lady_20"),
            (eq,":troop_no","trp_kingdom_1_lady_20"),
            (assign,reg0,200),#y
            (assign,reg2,120),#x
            (assign,":lady_num",0),
            (store_faction_of_troop,":fac_no",":troop_no"),
            (try_for_range,":lady_no","trp_kingdom_1_lady_1","trp_heroes_end"),
              (store_faction_of_troop,":fac_no1",":lady_no"),
              (eq,":fac_no1",":fac_no"),
              (val_add,":lady_num",1),
            (try_end),
            (store_mod,":offsetx",":lady_num",8),
            (val_sub,":offsetx",1),
            (val_mul,":offsetx",100),
            (val_add,reg2,":offsetx"),
          (else_try),
            (this_or_next|eq,":troop_no","trp_knight_6_20"),
            (this_or_next|eq,":troop_no","trp_knight_5_20"),
            (this_or_next|eq,":troop_no","trp_knight_4_20"),
            (this_or_next|eq,":troop_no","trp_knight_3_20"),
            (this_or_next|eq,":troop_no","trp_knight_2_20"),
            (eq,":troop_no","trp_knight_1_20"),
            (val_add,reg0,200),#y
            (assign,reg2,120),#x
            (assign,":lord_num",0),
            (store_faction_of_troop,":fac_no",":troop_no"),
            (try_for_range,":lord_no",lords_begin,lords_end),
              (store_faction_of_troop,":fac_no1",":lord_no"),
              (eq,":fac_no1",":fac_no"),
              (val_add,":lord_num",1),
            (try_end),
            (store_mod,":offsetx",":lord_num",8),
            (val_sub,":offsetx",1),
            (val_mul,":offsetx",100),
            (val_add,reg2,":offsetx"),
          (else_try),
            ...
            (val_add,reg0,200),#y
            (assign,reg2,120),#x
            (store_add,":cur_y",reg0,20),
            (assign,":cur_x",15),
            (create_text_overlay,reg1,"@kings:"),
            (position_set_x, pos1, ":cur_x"),
            (position_set_y, pos1, ":cur_y"),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 1200),
          ...
          (else_try),
            ...
            (store_add,":cur_y",reg0,20),
            (assign,":cur_x",15),
            (create_text_overlay,reg1,"@pretender:"),
            (position_set_x, pos1, ":cur_x"),
            (position_set_y, pos1, ":cur_y"),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 1200),
            ...
            (overlay_set_size, reg1, pos1),
          (else_try),
            (store_sub,":trp_no","trp_npc1",1),
            (eq,":troop_no",":trp_no"),
            (assign,reg0,200),#y
            (assign,reg2,120),#x
            (assign,":num",0),
            (try_for_range,":unused","trp_alayen","trp_npc1"),
              (val_add,":num",1),
            (try_end),
            (store_mod,":offsetx",":num",8),
            (val_sub,":offsetx",1),
            (val_mul,":offsetx",100),
            (val_add,reg2,":offsetx"),
          (else_try),
            (store_sub,":trp_no","trp_kingdom_1_lord",1),
            (eq,":troop_no",":trp_no"),
            (assign,reg0,200),#y
            (assign,reg2,120),#x
            (assign,":num",0),
            (try_for_range,":unused","trp_npc1","trp_kingdom_1_lord"),
              (val_add,":num",1),
            (try_end),
            (store_mod,":offsetx",":num",8),
            (val_sub,":offsetx",1),
            ...
            (val_add,reg2,":offsetx"),
          (else_try),
            (store_sub,":trp_no","trp_constable_hareck",1),#ulf
            (eq,":troop_no",":trp_no"),
            (assign,reg0,200),#y
            (assign,reg2,120),#x
            (assign,":num",0),
            (try_for_range,":unused","trp_wabbaer","trp_constable_hareck"),
              (val_add,":num",1),
            (try_end),
            (store_mod,":offsetx",":num",8),
            (val_sub,":offsetx",1),
          ...
          (try_begin),
            (this_or_next|eq,":troop_no","trp_knight_6_1"),
            (this_or_next|eq,":troop_no","trp_knight_5_1"),
            (this_or_next|eq,":troop_no","trp_knight_4_1"),
            (this_or_next|eq,":troop_no","trp_knight_3_1"),
            (this_or_next|eq,":troop_no","trp_knight_2_1"),
            (eq,":troop_no","trp_knight_1_1"),
            (store_add,":cur_y",reg0,20),
            (assign,":cur_x",15),
            (create_text_overlay,reg1,"@Lord:"),
            (position_set_x, pos1, ":cur_x"),
            (position_set_y, pos1, ":cur_y"),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 1200),
            ...
            (overlay_set_size, reg1, pos1),
          (else_try),
            (this_or_next|eq,":troop_no","trp_kingdom_6_lady_1"),#lady first
            (this_or_next|eq,":troop_no","trp_kingdom_5_lady_1"),
            (this_or_next|eq,":troop_no","trp_kingdom_4_lady_1"),
            (this_or_next|eq,":troop_no","trp_kingdom_3_lady_1"),
            (this_or_next|eq,":troop_no","trp_kingdom_2_lady_1"),
            (eq,":troop_no","trp_kingdom_1_lady_1"),
            (store_add,":cur_y",reg0,20),
            (assign,":cur_x",15),
            (create_text_overlay,reg1,"@Lady:"),
            (position_set_x, pos1, ":cur_x"),
            (position_set_y, pos1, ":cur_y"),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 1200),
          ...
          (troop_set_slot, "trp_temp_array_a", "$g_cur_slot_no", reg1),#avatar
          (troop_set_slot, "trp_temp_array_b", "$g_cur_slot_no", ":troop_no"),#cur_troop
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":slot_no", 0, "$g_cur_slot_no"),
          ...
          (troop_get_slot, ":selected_troop", "trp_temp_array_b", ":slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (assign, "$g_presentation_next_presentation", "prsnt_hero_note"),
          (start_presentation, "prsnt_troop_note"),
        (try_end),
  ...
  ("name_npc",0,0,[
      ...
      (try_begin),
        (eq,"$troop_need_rename","trp_brother"),
        (str_store_string, s1, "str_name_of_brother"),
      (else_try),
        (eq,"$troop_need_rename","trp_sister"),
        (str_store_string, s1, "str_name_of_sister"),
      (else_try),
  ...
  ("hero_army_report", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        ...
        (assign,":cur_y",200),
        (try_for_parties,":party_in_map"),
          (party_get_template_id,":pt_no",":party_in_map"),
          (eq,":pt_no","pt_hero_army"),
          (str_store_party_name,s1,":party_in_map"),
        ...
        (val_add,":cur_y",40),
        (create_text_overlay, reg1, "@exit_army:"),
        ...
        (store_add,":pos_y",":cur_y",45),
        (assign,":cur_y",":pos_y"),
        (assign,":cur_x",60),
        (store_sub,":fac_num","fac_faction_end","fac_wabber"),
        (store_mod,":need",":fac_num",2),
        (val_div,":fac_num",2),
        (assign,":fac_num_1",0),
        (try_for_range,":cur_fac","fac_wabber","fac_faction_end"),
          (val_add,":fac_num_1",1),
          (store_relation, ":faction_relation", ":cur_fac", "fac_player_supporters_faction"),
          (str_store_faction_name,s1,":cur_fac"),
          (assign,reg1,":faction_relation"),
          (create_text_overlay,reg1,"@{s1}:{reg1}"),
          (position_set_x, pos1, ":cur_x"),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg1, pos1),
          (position_set_x, pos1, 1000),
        ...
        (val_add,":cur_y",40),
        (create_text_overlay, reg1, "@Relation_fac"),
  ...
  ("new_mod_setting", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        ...
        (assign,":cur_y",200),
        (create_text_overlay, reg1, "@if show all:"),
        (position_set_x, pos1, 25),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 1000),
        ...
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_4", pos1),
        (overlay_set_val, "$g_presentation_obj_4","$show_all_troop"),

        (val_add,":cur_y",25),

        (create_text_overlay, reg1, "@horse archer:"),
        (position_set_x, pos1, 25),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 1000),
        ...
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_3", pos1),
        (overlay_set_val, "$g_presentation_obj_3","$horse_archer_enhance"),

        (val_add,":cur_y",25),

        (create_text_overlay, reg1, "@hero_leave:"),
        (position_set_x, pos1, 25),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 1000),
        ...
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_2", pos1),
        (overlay_set_val, "$g_presentation_obj_2","$hero_leave_forever"),
    ...
    (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          (eq, ":object", "$g_presentation_obj_4"),
          (assign,"$show_all_troop",":value"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_3"),
          (assign,"$horse_archer_enhance",":value"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_2"),
          (assign,"$hero_leave_forever",":value"),
        (try_end),
        ]),
  ]),

  ("magic_presentation", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        ...
        (assign,":cur_y",200),
        (assign, "$g_cur_slot_no", 0),
        (try_for_range_backwards,":magic_no","str_magic_1","str_magic_1_info"),
          (create_button_overlay,s1,":magic_no"),
          (position_set_x, pos1, 25),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg1, pos1),
          (position_set_x, pos1, 1000),
          ...
          (troop_set_slot, "trp_temp_array_b", "$g_cur_slot_no", ":magic_no"),
          (val_add, "$g_cur_slot_no", 1),
          (val_add,":cur_y",25),
        (try_end),
    ...
    (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (try_for_range, ":slot_no", 0, "$g_cur_slot_no"),
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
          (troop_get_slot, ":selected_magic", "trp_temp_array_b", ":slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_magic"),
          (assign, "$g_presentation_next_presentation", "prsnt_magic_presentation"),
          (start_presentation, "prsnt_magic_specific"),
        (try_end),
  ...
  ("magic_specific", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        ...
        (assign, ":selected_magic", "$g_prsnt_param_1"),
        ## back
        (create_game_button_overlay, "$g_presentation_obj_5", "@Done"),
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 25),
        ...
        (try_begin),
          (create_game_button_overlay, "$g_presentation_obj_4", "@start_magic"),
          (position_set_x, pos1, 50),
          (position_set_y, pos1, 25),
          (overlay_set_position, "$g_presentation_obj_4", pos1),
        (try_end),

        (str_store_string,s0,":selected_magic"),
        (create_text_overlay, reg0, s0, tf_double_space),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg0, pos1),
        (position_set_x, pos1, 1200),
        ...
        (assign,":info_no",":selected_magic"),
        (val_sub,":info_no","str_magic_1"),
        (val_add,":info_no","str_magic_1_info"),
        (str_store_string,s0,":info_no"),
        (create_text_overlay, reg0, s0, tf_double_space),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 500),
        (overlay_set_position, reg0, pos1),
        ...
        (assign, "$g_cur_slot_no", 0),
        (try_begin),
        (this_or_next|eq,":selected_magic","str_magic_1"),
        (this_or_next|eq,":selected_magic","str_magic_2"),
        (assign,":continue",1),#need a target
        (eq,":selected_magic","str_magic_7"),
          (try_for_range_backwards,":party_no",centers_begin,centers_end),
            (str_store_party_name,s1,":party_no"),
            (create_button_overlay, reg0, s1, tf_double_space),
            (position_set_x, pos1,900),
            (position_set_y, pos1,":cur_y"),
            (overlay_set_position, reg0, pos1),
            (position_set_x, pos1, 1000),
            ...
            (troop_set_slot, "trp_temp_array_b", "$g_cur_slot_no", ":party_no"),
            (val_add, "$g_cur_slot_no", 1),
            (val_add,":cur_y",25),
          (try_end),
        (else_try),
          (eq,":selected_magic","str_magic_6"),
          (assign,":continue",1),
          (try_for_parties,":party_no",centers_begin,centers_end),
            (store_distance_to_party_from_party,":des",":party_no","p_main_party"),
            (lt,":des",50),
            (str_store_party_name,s1,":party_no"),
            (create_button_overlay, reg0, s1, tf_double_space),
            (position_set_x, pos1,900),
        ...
        (try_begin),
          (eq,":continue",1),
          (assign, ":selected_party", "$g_prsnt_param_2"),
          (try_begin),
            (ge,":selected_party",1),
            (str_store_party_name,s0,":selected_party"),
          (else_try),
            (str_store_string,s0,"str_empty_string"),
          (try_end),

          (str_store_string,s0,"@target:{s0}"),
          (create_text_overlay, reg0, s0, tf_double_space),
          (position_set_x, pos1, 50),
          (position_set_y, pos1, 350),
          (overlay_set_position, reg0, pos1),
    ...
    (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (try_for_range, ":slot_no", 0, "$g_cur_slot_no"),
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
          (troop_get_slot, ":selected_party", "trp_temp_array_b", ":slot_no"),
          (assign, "$g_prsnt_param_2", ":selected_party"),
          (start_presentation, "prsnt_magic_specific"),
        (try_end),
